		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getHyGreaterExpressionAccess().getAlternatives(), "rule__HyGreaterExpression__Alternatives");
					put(grammarAccess.getHyLessExpressionAccess().getAlternatives(), "rule__HyLessExpression__Alternatives");
					put(grammarAccess.getHyGreaterOrEqualExpressionAccess().getAlternatives(), "rule__HyGreaterOrEqualExpression__Alternatives");
					put(grammarAccess.getHyLessOrEqualExpressionAccess().getAlternatives(), "rule__HyLessOrEqualExpression__Alternatives");
					put(grammarAccess.getHyEqualExpressionAccess().getAlternatives(), "rule__HyEqualExpression__Alternatives");
					...
					put(grammarAccess.getHyGreaterExpressionAccess().getGroup_0(), "rule__HyGreaterExpression__Group_0__0");
					put(grammarAccess.getHyLessExpressionAccess().getGroup_0(), "rule__HyLessExpression__Group_0__0");
					put(grammarAccess.getHyGreaterOrEqualExpressionAccess().getGroup_0(), "rule__HyGreaterOrEqualExpression__Group_0__0");
					put(grammarAccess.getHyLessOrEqualExpressionAccess().getGroup_0(), "rule__HyLessOrEqualExpression__Group_0__0");
					put(grammarAccess.getHyEqualExpressionAccess().getGroup_0(), "rule__HyEqualExpression__Group_0__0");
					...
					put(grammarAccess.getHyGreaterExpressionAccess().getOperand1Assignment_0_0(), "rule__HyGreaterExpression__Operand1Assignment_0_0");
					put(grammarAccess.getHyGreaterExpressionAccess().getOperand2Assignment_0_2(), "rule__HyGreaterExpression__Operand2Assignment_0_2");
					put(grammarAccess.getHyLessExpressionAccess().getOperand1Assignment_0_0(), "rule__HyLessExpression__Operand1Assignment_0_0");
					put(grammarAccess.getHyLessExpressionAccess().getOperand2Assignment_0_2(), "rule__HyLessExpression__Operand2Assignment_0_2");
					put(grammarAccess.getHyGreaterOrEqualExpressionAccess().getOperand1Assignment_0_0(), "rule__HyGreaterOrEqualExpression__Operand1Assignment_0_0");
					put(grammarAccess.getHyGreaterOrEqualExpressionAccess().getOperand2Assignment_0_2(), "rule__HyGreaterOrEqualExpression__Operand2Assignment_0_2");
					put(grammarAccess.getHyLessOrEqualExpressionAccess().getOperand1Assignment_0_0(), "rule__HyLessOrEqualExpression__Operand1Assignment_0_0");
					put(grammarAccess.getHyLessOrEqualExpressionAccess().getOperand2Assignment_0_2(), "rule__HyLessOrEqualExpression__Operand2Assignment_0_2");
					put(grammarAccess.getHyEqualExpressionAccess().getOperand1Assignment_0_0(), "rule__HyEqualExpression__Operand1Assignment_0_0");
					put(grammarAccess.getHyEqualExpressionAccess().getOperand2Assignment_0_2(), "rule__HyEqualExpression__Operand2Assignment_0_2");

package de.darwinspl.feature.graphical.editor.locators;
...
public class DwFeatureCellEditorLocator implements CellEditorLocator{
	private Label label;
	
	public DwFeatureCellEditorLocator(Label label){
		this.label = label;
	}

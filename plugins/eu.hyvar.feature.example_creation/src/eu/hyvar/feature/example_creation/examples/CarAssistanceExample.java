...
//	HyFeatureFactory factory = HyFeatureFactory.eINSTANCE;
	...
	public HyFeatureModel createExample() {
		...
		HyFeature infotainmentFeature = HyFeatureCreationUtil.createFeature(infotainmentType, infotainmentName, null, null);
...
//		featureExporter.exportFeatureModel(constraintModel, initialDate);
		...
		HyGroup frontDistanceSensorsAlternativeGroup = HyFeatureCreationUtil.createGroup(frontDistanceSensorsAlternativeGroupType, firstDate, null);

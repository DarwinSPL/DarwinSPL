...
/**
 * This is the item provider adapter for a {@link eu.hyvar.evolution.HyInterval} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HyIntervalItemProvider 
	 ...
	 * @generated
	 */
	public HyIntervalItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HyInterval"));
	}
	...
	public String getText(Object object) {
		String label = ((HyInterval)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_HyInterval_type") :
			getString("_UI_HyInterval_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HyInterval.class)) {
			case HyEvolutionPackage.HY_INTERVAL__VALID_SINCE:
			case HyEvolutionPackage.HY_INTERVAL__VALID_UNTIL:
			case HyEvolutionPackage.HY_INTERVAL__ID:

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Dw False Optional Feature Anomaly</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.darwinspl.anomaly.impl.DwFalseOptionalFeatureAnomalyImpl#getValidSince <em>Valid Since</em>}</li>
 *   <li>{@link de.darwinspl.anomaly.impl.DwFalseOptionalFeatureAnomalyImpl#getValidUntil <em>Valid Until</em>}</li>
 *   <li>{@link de.darwinspl.anomaly.impl.DwFalseOptionalFeatureAnomalyImpl#getId <em>Id</em>}</li>
 *   <li>{@link de.darwinspl.anomaly.impl.DwFalseOptionalFeatureAnomalyImpl#getFeature <em>Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DwFalseOptionalFeatureAnomalyImpl extends MinimalEObjectImpl.Container implements DwFalseOptionalFeatureAnomaly {
	/**
	 ...
	 * @generated
	 */
	protected DwFalseOptionalFeatureAnomalyImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DwAnomalyPackage.Literals.DW_FALSE_OPTIONAL_FEATURE_ANOMALY;
	}
	...
	public void setValidSince(Date newValidSince) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DwAnomalyPackage.DW_FALSE_OPTIONAL_FEATURE_ANOMALY__VALID_SINCE, oldValidSince, validSince));
	}
	...
	public void setValidUntil(Date newValidUntil) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DwAnomalyPackage.DW_FALSE_OPTIONAL_FEATURE_ANOMALY__VALID_UNTIL, oldValidUntil, validUntil));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DwAnomalyPackage.DW_FALSE_OPTIONAL_FEATURE_ANOMALY__ID, oldId, id));
	}
	...
	public HyFeature getFeature() {
		if (feature != null && feature.eIsProxy()) {
			...
			if (feature != oldFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DwAnomalyPackage.DW_FALSE_OPTIONAL_FEATURE_ANOMALY__FEATURE, oldFeature, feature));
			}
		}
		return feature;
	}
	...
	public void setFeature(HyFeature newFeature) {
		...
		feature = newFeature;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DwAnomalyPackage.DW_FALSE_OPTIONAL_FEATURE_ANOMALY__FEATURE, oldFeature, feature));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DwAnomalyPackage.DW_FALSE_OPTIONAL_FEATURE_ANOMALY__ID:
				return getId();
			case DwAnomalyPackage.DW_FALSE_OPTIONAL_FEATURE_ANOMALY__FEATURE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DwAnomalyPackage.DW_FALSE_OPTIONAL_FEATURE_ANOMALY___CREATE_ID:
				return createId();
		}
...
} //DwFalseOptionalFeatureAnomalyImpl

 ...
 * </p>
 */
public class DwprofileSyntaxColoringPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public DwprofileSyntaxColoringPreferencePage() {
		super();
		
		de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileMetaInformation metaInformation = new de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileMetaInformation();
		...
		setPreferenceStore(de.darwinspl.preferences.resource.dwprofile.ui.DwprofileUIPlugin.getDefault().getPreferenceStore());
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = de.darwinspl.preferences.resource.dwprofile.ui.DwprofileSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.darwinspl.preferences.resource.dwprofile.ui.DwprofileSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = de.darwinspl.preferences.resource.dwprofile.ui.DwprofileSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.darwinspl.preferences.resource.dwprofile.ui.DwprofileSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = de.darwinspl.preferences.resource.dwprofile.ui.DwprofileSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.darwinspl.preferences.resource.dwprofile.ui.DwprofileSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = de.darwinspl.preferences.resource.dwprofile.ui.DwprofileSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.darwinspl.preferences.resource.dwprofile.ui.DwprofileSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = de.darwinspl.preferences.resource.dwprofile.ui.DwprofileSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.darwinspl.preferences.resource.dwprofile.ui.DwprofileSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = de.darwinspl.preferences.resource.dwprofile.ui.DwprofileSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.darwinspl.preferences.resource.dwprofile.ui.DwprofileSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(Composite composite, int horizontalSpan) {
		de.darwinspl.preferences.resource.dwprofile.ui.DwprofilePixelConverter pixelConverter = new de.darwinspl.preferences.resource.dwprofile.ui.DwprofilePixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof de.darwinspl.preferences.resource.dwprofile.ui.DwprofileEditor) {
			de.darwinspl.preferences.resource.dwprofile.ui.DwprofileEditor emfTextEditor = (de.darwinspl.preferences.resource.dwprofile.ui.DwprofileEditor) editor;

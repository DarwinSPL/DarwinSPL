 ...
 * a specified depth.
 */
public class DwprofileOutlinePageTreeViewer extends TreeViewer {
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof de.darwinspl.preferences.resource.dwprofile.ui.DwprofileEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			de.darwinspl.preferences.resource.dwprofile.mopp.DwprofilePlugin.logError("Exception while refreshing outline view", e);
		}
	}

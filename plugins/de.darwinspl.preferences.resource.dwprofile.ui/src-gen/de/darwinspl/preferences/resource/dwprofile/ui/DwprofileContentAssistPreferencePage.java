 ...
 */
public class DwprofileContentAssistPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public DwprofileContentAssistPreferencePage() {
		initialize();
	}
	...
	public void init(IWorkbench workbench) {
		...
		// init values
		assistEnabled = preferenceStore.getBoolean(de.darwinspl.preferences.resource.dwprofile.ui.DwprofilePreferenceConstants.EDITOR_CONTENT_ASSIST_ENABLED);
		activationDelay = preferenceStore.getInt(de.darwinspl.preferences.resource.dwprofile.ui.DwprofilePreferenceConstants.EDITOR_CONTENT_ASSIST_DELAY);
		activationTriggers = preferenceStore.getString(de.darwinspl.preferences.resource.dwprofile.ui.DwprofilePreferenceConstants.EDITOR_CONTENT_ASSIST_TRIGGERS);
	}
	...
	protected void performDefaults() {
		IPreferenceStore preferenceStore = getPreferenceStore();
		assistEnabled = preferenceStore.getDefaultBoolean(de.darwinspl.preferences.resource.dwprofile.ui.DwprofilePreferenceConstants.EDITOR_CONTENT_ASSIST_ENABLED);
		activationDelay = preferenceStore.getDefaultInt(de.darwinspl.preferences.resource.dwprofile.ui.DwprofilePreferenceConstants.EDITOR_CONTENT_ASSIST_DELAY);
		activationTriggers = preferenceStore.getDefaultString(de.darwinspl.preferences.resource.dwprofile.ui.DwprofilePreferenceConstants.EDITOR_CONTENT_ASSIST_TRIGGERS);
		// defaults in widgets
	...
	private boolean updatePreferences() {
		...
		try {
			...
			de.darwinspl.preferences.resource.dwprofile.mopp.DwprofilePlugin.getDefault().getLog().log(			new Status(IStatus.ERROR			, de.darwinspl.preferences.resource.dwprofile.ui.DwprofileUIPlugin.getDefault().getBundle().getSymbolicName()			, "Value '" + delayText + "' is no valid delay value"			, exception)			);
			return false;
		}
		activationTriggers = txtTriggers.getText();
		IPreferenceStore preferenceStore = getPreferenceStore();
		preferenceStore.setValue(de.darwinspl.preferences.resource.dwprofile.ui.DwprofilePreferenceConstants.EDITOR_CONTENT_ASSIST_ENABLED, assistEnabled);
		preferenceStore.setValue(de.darwinspl.preferences.resource.dwprofile.ui.DwprofilePreferenceConstants.EDITOR_CONTENT_ASSIST_DELAY, activationDelay);
		preferenceStore.setValue(de.darwinspl.preferences.resource.dwprofile.ui.DwprofilePreferenceConstants.EDITOR_CONTENT_ASSIST_TRIGGERS, activationTriggers);
		return true;
	}

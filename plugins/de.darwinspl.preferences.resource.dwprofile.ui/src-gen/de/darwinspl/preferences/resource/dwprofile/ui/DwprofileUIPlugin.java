 ...
 */
public class DwprofileUIPlugin extends AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "de.darwinspl.preferences.resource.dwprofile.ui";
	public static final String EDITOR_ID = "de.darwinspl.preferences.resource.dwprofile.ui.DwprofileEditor";
	...
	private static DwprofileUIPlugin plugin;
	
	public DwprofileUIPlugin() {
		super();
	}
	...
	public static DwprofileUIPlugin getDefault() {
		return plugin;
	}
	...
	protected static IStatus log(int type, String message, Throwable throwable) {
		IStatus status;
		if (throwable != null) {
			status = new Status(type, DwprofileUIPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new Status(type, DwprofileUIPlugin.PLUGIN_ID, message);
		}
		final DwprofileUIPlugin pluginInstance = DwprofileUIPlugin.getDefault();

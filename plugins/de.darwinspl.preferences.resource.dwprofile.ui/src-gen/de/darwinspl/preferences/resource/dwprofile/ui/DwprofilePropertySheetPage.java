...
public class DwprofilePropertySheetPage extends PropertySheetPage implements ISelectionChangedListener {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection iSelection) {
		...
		if (iSelection instanceof de.darwinspl.preferences.resource.dwprofile.ui.DwprofileEObjectSelection) {
			final de.darwinspl.preferences.resource.dwprofile.ui.DwprofileEObjectSelection selection = (de.darwinspl.preferences.resource.dwprofile.ui.DwprofileEObjectSelection) iSelection;

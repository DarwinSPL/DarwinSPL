 ...
 */
public class DwprofileCompletionProposal implements Comparable<DwprofileCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileExpectedTerminal expectedTerminal;
	...
	public DwprofileCompletionProposal(de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public DwprofileCompletionProposal(de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public DwprofileCompletionProposal(de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof DwprofileCompletionProposal) {
			DwprofileCompletionProposal other = (DwprofileCompletionProposal) object;
	...
	public int compareTo(DwprofileCompletionProposal object) {
		if (object instanceof DwprofileCompletionProposal) {
			DwprofileCompletionProposal other = (DwprofileCompletionProposal) object;

 ...
 */
public class DwprofileHighlighting implements ISelectionProvider, ISelectionChangedListener {
	...
	private de.darwinspl.preferences.resource.dwprofile.ui.DwprofileEditor editor;
	private ProjectionViewer projectionViewer;
	private de.darwinspl.preferences.resource.dwprofile.ui.DwprofileOccurrence occurrence;
	private de.darwinspl.preferences.resource.dwprofile.ui.DwprofileBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, de.darwinspl.preferences.resource.dwprofile.IDwprofileBackgroundParsingListener {
	...
	private void addListeners(de.darwinspl.preferences.resource.dwprofile.ui.DwprofileEditor editor) {
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, de.darwinspl.preferences.resource.dwprofile.ui.DwprofilePositionCategory.BRACKET.toString());
	}
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new de.darwinspl.preferences.resource.dwprofile.ui.DwprofileEObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		isHighlightBrackets = preferenceStore.getBoolean(de.darwinspl.preferences.resource.dwprofile.ui.DwprofilePreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, de.darwinspl.preferences.resource.dwprofile.ui.DwprofilePreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));

 ...
 * olInput</code>.
 */
public class DwprofileDocBrowserInformationControlInput {
	
	private final DwprofileDocBrowserInformationControlInput fPrevious;
	private DwprofileDocBrowserInformationControlInput fNext;
	 ...
	 */
	public DwprofileDocBrowserInformationControlInput(DwprofileDocBrowserInformationControlInput previous, EObject element, Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public DwprofileDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public DwprofileDocBrowserInformationControlInput getNext() {
		return fNext;
	}

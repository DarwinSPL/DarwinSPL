 ...
 */
public class DwprofileOutlinePage extends Page implements ISelectionProvider, ISelectionChangedListener, IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "de.darwinspl.preferences.resource.dwprofile.ui.outlinecontext";
	...
	public DwprofileOutlinePage(de.darwinspl.preferences.resource.dwprofile.IDwprofileResourceProvider resourceProvider) {
		super();
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("de.darwinspl.preferences.resource.dwprofile.ui.outlinecontext", menuManager, treeViewer);
	}

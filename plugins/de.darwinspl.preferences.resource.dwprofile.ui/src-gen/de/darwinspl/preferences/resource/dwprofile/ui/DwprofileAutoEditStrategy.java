...
/**
 * The DwprofileAutoEditStrategy extends the default auto edit strategy such that
 ...
 */
public class DwprofileAutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	
	private de.darwinspl.preferences.resource.dwprofile.ui.DwprofileBracketSet bracketSet;
	
	public DwprofileAutoEditStrategy() {
		super();
		...
		if (plugin != null) {
			...
			bracketSet = new de.darwinspl.preferences.resource.dwprofile.ui.DwprofileBracketSet();
	 ...
	 */
	@Deprecated
	public void setBracketSet(de.darwinspl.preferences.resource.dwprofile.ui.DwprofileBracketSet bracketSet) {

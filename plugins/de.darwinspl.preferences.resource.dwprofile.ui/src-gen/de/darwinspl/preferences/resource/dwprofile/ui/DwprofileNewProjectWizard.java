 ...
 * </p>
 */
public class DwprofileNewProjectWizard extends Wizard implements INewWizard, IExecutableExtension {
	
	/**
	 * The name of the ZIP file that is used as content for the new project (relative
	 * to the root of the resource UI plug-in).
	 */
	public final static String NEW_PROJECT_ZIP_FILE_NAME = de.darwinspl.preferences.resource.dwprofile.ui.DwprofileUIResourceBundle.NEW_PROJECT_ZIP_FILE_NAME;
	 ...
	 */
	protected String pageName = de.darwinspl.preferences.resource.dwprofile.ui.DwprofileUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_NAME;
	 ...
	 */
	protected String pageDescription = de.darwinspl.preferences.resource.dwprofile.ui.DwprofileUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_DESCRIPTION;
	
	/**
	 * The name of the project in the project creation page
	 */
	protected String pageProjectName = de.darwinspl.preferences.resource.dwprofile.ui.DwprofileUIResourceBundle.NEW_PROJECT_WIZARD_PROJECT_NAME;
	 ...
	 * de.darwinspl.preferences.resource.dwprofile.ui.DwprofileNewProjectWizardLogic.
	 */
	...
	protected void doPerformFinish(IProgressMonitor monitor) throws Exception {
		new de.darwinspl.preferences.resource.dwprofile.ui.DwprofileNewProjectWizardLogic().createExampleProject(monitor, wizardNewProjectCreationPage.getLocationPath(), wizardNewProjectCreationPage.getProjectName(), de.darwinspl.preferences.resource.dwprofile.ui.DwprofileUIPlugin.PLUGIN_ID, NEW_PROJECT_ZIP_FILE_NAME);
	}

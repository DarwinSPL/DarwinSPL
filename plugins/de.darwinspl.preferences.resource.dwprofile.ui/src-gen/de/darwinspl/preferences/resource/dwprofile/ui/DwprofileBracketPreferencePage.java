 ...
 * </p>
 */
public class DwprofileBracketPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = de.darwinspl.preferences.resource.dwprofile.ui.DwprofilePreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileMetaInformation().getSyntaxName();
	
	private de.darwinspl.preferences.resource.dwprofile.ui.DwprofileBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public DwprofileBracketPreferencePage() {
		super();
		
		de.darwinspl.preferences.resource.dwprofile.IDwprofileMetaInformation metaInformation = new de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileMetaInformation();
	...
	public void init(IWorkbench workbench) {
		...
		bracketsTmp = new de.darwinspl.preferences.resource.dwprofile.ui.DwprofileBracketSet();
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + de.darwinspl.preferences.resource.dwprofile.ui.DwprofilePreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void addListenersToStyleButtons() {
		...
		bracketsList.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				de.darwinspl.preferences.resource.dwprofile.IDwprofileBracketPair bracketPair = getSelectedBracketPair();
				if (bracketPair == null) {
					removeBracketButton.setEnabled(false);
					return;
				}
	...
	protected de.darwinspl.preferences.resource.dwprofile.IDwprofileBracketPair getSelectedBracketPair() {

 ...
 */
public class DwprofileBackgroundParsingStrategy {
	 ...
	 */
	public void parse(DocumentEvent event, final de.darwinspl.preferences.resource.dwprofile.IDwprofileTextResource resource, final de.darwinspl.preferences.resource.dwprofile.ui.DwprofileEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(IDocument document, final de.darwinspl.preferences.resource.dwprofile.IDwprofileTextResource resource, final de.darwinspl.preferences.resource.dwprofile.ui.DwprofileEditor editor, long delay) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileResource) {
							de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileResource concreteResource = (de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileResource) resource;

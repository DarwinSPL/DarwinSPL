...
public class DwprofileOutlinePageTreeViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof EObject && o2 instanceof EObject) {
			...
			de.darwinspl.preferences.resource.dwprofile.IDwprofileNameProvider nameProvider = new de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileMetaInformation().createNameProvider();

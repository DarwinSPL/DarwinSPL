 ...
 */
public class HymanifestHighlighting implements ISelectionProvider, ISelectionChangedListener {
	...
	private eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestEditor editor;
	private ProjectionViewer projectionViewer;
	private eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestOccurrence occurrence;
	private eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestBackgroundParsingListener {
	...
	private void addListeners(eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestEditor editor) {
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestPositionCategory.BRACKET.toString());
	}
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestEObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		isHighlightBrackets = preferenceStore.getBoolean(eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));

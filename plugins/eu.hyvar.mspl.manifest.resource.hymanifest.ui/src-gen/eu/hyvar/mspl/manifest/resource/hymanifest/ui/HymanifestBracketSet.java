 ...
 */
public class HymanifestBracketSet {
	...
	private ArrayList<eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestBracketPair> bracketPairs;
	private String languageID;
	
	/**
	 * Creates a new bracket set to manage bracket pairs.
	 */
	public HymanifestBracketSet() {
		super();
		this.languageID = new eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestMetaInformation().getSyntaxName();
		this.bracketPairs = new ArrayList<eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestBracketPair>();
	}
	...
	public eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestBracketPair getBracketPair(String opening, String closing) {
		for (eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestBracketPair bracketPair : bracketPairs) {
	...
	public boolean addBracketPair(String opening, String closing, boolean closingEnabledInside, boolean closeAfterEnter) {
		...
		bracketPairs.add(new eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestBracketPair(opening, closing, closingEnabledInside, closeAfterEnter));
		return true;
	}
	...
	public boolean resetBrackets(IPreferenceStore preferenceStore) {
		String bracketPairs = preferenceStore.getString(languageID + eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestBracketPair remove(String opening, String closing) {
		for (eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public void deserialize(String bracketSet) {
		bracketPairs = new ArrayList<eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestBracketPair>();
	...
	public void highlightBrackets(IDocument document, int position, int caretOffset) {
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}

 ...
 */
public class HymanifestUIPlugin extends AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "eu.hyvar.mspl.manifest.resource.hymanifest.ui";
	public static final String EDITOR_ID = "eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestEditor";
	...
	private static HymanifestUIPlugin plugin;
	
	public HymanifestUIPlugin() {
		super();
	}
	...
	public static HymanifestUIPlugin getDefault() {
		return plugin;
	}
	...
	protected static IStatus log(int type, String message, Throwable throwable) {
		IStatus status;
		if (throwable != null) {
			status = new Status(type, HymanifestUIPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new Status(type, HymanifestUIPlugin.PLUGIN_ID, message);
		}
		final HymanifestUIPlugin pluginInstance = HymanifestUIPlugin.getDefault();

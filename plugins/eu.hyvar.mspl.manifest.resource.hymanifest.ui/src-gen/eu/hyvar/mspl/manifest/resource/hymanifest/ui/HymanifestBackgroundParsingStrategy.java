 ...
 */
public class HymanifestBackgroundParsingStrategy {
	 ...
	 */
	public void parse(DocumentEvent event, final eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestTextResource resource, final eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(IDocument document, final eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestTextResource resource, final eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestEditor editor, long delay) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestResource) {
							eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestResource concreteResource = (eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestResource) resource;

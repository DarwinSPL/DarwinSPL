 ...
 */
public class HymanifestCompletionProposal implements Comparable<HymanifestCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestExpectedTerminal expectedTerminal;
	...
	public HymanifestCompletionProposal(eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public HymanifestCompletionProposal(eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public HymanifestCompletionProposal(eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof HymanifestCompletionProposal) {
			HymanifestCompletionProposal other = (HymanifestCompletionProposal) object;
	...
	public int compareTo(HymanifestCompletionProposal object) {
		if (object instanceof HymanifestCompletionProposal) {
			HymanifestCompletionProposal other = (HymanifestCompletionProposal) object;

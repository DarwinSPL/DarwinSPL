 ...
 */
public class HymanifestOutlinePage extends Page implements ISelectionProvider, ISelectionChangedListener, IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "eu.hyvar.mspl.manifest.resource.hymanifest.ui.outlinecontext";
	...
	public HymanifestOutlinePage(eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestResourceProvider resourceProvider) {
		super();
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("eu.hyvar.mspl.manifest.resource.hymanifest.ui.outlinecontext", menuManager, treeViewer);
	}

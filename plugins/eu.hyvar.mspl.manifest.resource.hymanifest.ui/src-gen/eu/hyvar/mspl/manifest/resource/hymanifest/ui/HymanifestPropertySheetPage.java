...
public class HymanifestPropertySheetPage extends PropertySheetPage implements ISelectionChangedListener {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection iSelection) {
		...
		if (iSelection instanceof eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestEObjectSelection) {
			final eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestEObjectSelection selection = (eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestEObjectSelection) iSelection;

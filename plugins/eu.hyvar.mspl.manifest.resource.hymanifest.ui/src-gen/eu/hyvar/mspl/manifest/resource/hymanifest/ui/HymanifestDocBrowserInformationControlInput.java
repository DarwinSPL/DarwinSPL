 ...
 * olInput</code>.
 */
public class HymanifestDocBrowserInformationControlInput {
	
	private final HymanifestDocBrowserInformationControlInput fPrevious;
	private HymanifestDocBrowserInformationControlInput fNext;
	 ...
	 */
	public HymanifestDocBrowserInformationControlInput(HymanifestDocBrowserInformationControlInput previous, EObject element, Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public HymanifestDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public HymanifestDocBrowserInformationControlInput getNext() {
		return fNext;
	}

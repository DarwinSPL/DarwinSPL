...
/**
 * The HymanifestAutoEditStrategy extends the default auto edit strategy such that
 ...
 */
public class HymanifestAutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	
	private eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestBracketSet bracketSet;
	
	public HymanifestAutoEditStrategy() {
		super();
		...
		if (plugin != null) {
			...
			bracketSet = new eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestBracketSet();
	 ...
	 */
	@Deprecated
	public void setBracketSet(eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestBracketSet bracketSet) {

...
public class HymanifestOutlinePageTreeViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof EObject && o2 instanceof EObject) {
			...
			eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestNameProvider nameProvider = new eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestMetaInformation().createNameProvider();

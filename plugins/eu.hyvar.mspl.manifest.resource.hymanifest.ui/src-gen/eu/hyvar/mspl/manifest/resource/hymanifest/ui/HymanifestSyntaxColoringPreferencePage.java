 ...
 * </p>
 */
public class HymanifestSyntaxColoringPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public HymanifestSyntaxColoringPreferencePage() {
		super();
		
		eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestMetaInformation metaInformation = new eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(Composite composite, int horizontalSpan) {
		eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestPixelConverter pixelConverter = new eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestEditor) {
			eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestEditor emfTextEditor = (eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestEditor) editor;

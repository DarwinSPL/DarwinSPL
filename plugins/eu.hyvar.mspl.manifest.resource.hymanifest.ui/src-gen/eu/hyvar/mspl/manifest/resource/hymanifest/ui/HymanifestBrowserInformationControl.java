 ...
 * @since 3.2
 */
public class HymanifestBrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	...
	private eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestDocBrowserInformationControlInput fInput;
	 ...
	 */
	public HymanifestBrowserInformationControl(Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public HymanifestBrowserInformationControl(Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public HymanifestBrowserInformationControl(Shell parent, String symbolicFontName, ToolBarManager toolBarManager) {
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestHTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}
	 ...
	 */
	public eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestDocBrowserInformationControlInput getInput() {
		return fInput;
	}

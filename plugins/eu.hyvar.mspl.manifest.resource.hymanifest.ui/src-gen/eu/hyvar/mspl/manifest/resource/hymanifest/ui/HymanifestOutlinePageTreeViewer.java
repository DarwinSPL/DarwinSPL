 ...
 * a specified depth.
 */
public class HymanifestOutlinePageTreeViewer extends TreeViewer {
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestPlugin.logError("Exception while refreshing outline view", e);
		}
	}

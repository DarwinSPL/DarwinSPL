 ...
 */
public class HymanifestTextHover implements ITextHover, ITextHoverExtension, ITextHoverExtension2 {
	...
	private eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends Action {
		...
		private final eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestDocBrowserInformationControlInput infoInput = (eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestHyperlink hyperlink = new eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	 ...
	 */
	public HymanifestTextHover(eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
		...
		return ((eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestDocBrowserInformationControlInput internalGetHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
	 ...
	 */
	private eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestDocBrowserInformationControlInput getHoverInfo(List<EObject> elements, ITextViewer textViewer, eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestHTMLPrinter.insertPageProlog(buffer, 0, eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestTextHover.getStyleSheet());
			eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestHTMLPrinter.addPageEpilog(buffer);
			return new eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		Bundle bundle = Platform.getBundle(eu.hyvar.mspl.manifest.resource.hymanifest.ui.HymanifestUIPlugin.PLUGIN_ID);
		URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return eu.hyvar.mspl.manifest.resource.hymanifest.util.HymanifestStreamUtil.getContent(styleSheetURL.openStream());

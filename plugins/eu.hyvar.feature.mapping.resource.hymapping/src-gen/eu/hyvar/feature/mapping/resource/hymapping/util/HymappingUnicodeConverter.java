 ...
 * to 4 bytes).
 */
public class HymappingUnicodeConverter extends eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingInputStreamProcessor {
	 ...
	 */
	public HymappingUnicodeConverter(InputStream inputStream) {

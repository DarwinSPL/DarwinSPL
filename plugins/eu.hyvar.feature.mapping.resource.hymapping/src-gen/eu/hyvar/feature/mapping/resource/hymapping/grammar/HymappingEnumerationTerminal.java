 ...
 */
public class HymappingEnumerationTerminal extends eu.hyvar.feature.mapping.resource.hymapping.grammar.HymappingTerminal {
	
	private Map<String, String> mapping = new LinkedHashMap<String, String>();
	
	public HymappingEnumerationTerminal(EStructuralFeature attribute, String[] literalMappings, eu.hyvar.feature.mapping.resource.hymapping.grammar.HymappingCardinality cardinality, int mandatoryOccurrencesAfter) {

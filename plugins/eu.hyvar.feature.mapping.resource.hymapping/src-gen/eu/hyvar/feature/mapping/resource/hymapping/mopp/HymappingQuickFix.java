...
public abstract class HymappingQuickFix implements eu.hyvar.feature.mapping.resource.hymapping.IHymappingQuickFix {
	...
	public HymappingQuickFix(String displayString, String imageKey, EObject contextObject) {
		this(displayString, imageKey, Collections.singleton(contextObject), contextObject.eResource());
	}
	
	public HymappingQuickFix(String displayString, String imageKey, Collection<EObject> contextObjects) {
		this(displayString, imageKey, contextObjects, contextObjects.iterator().next().eResource());
	}
	
	public HymappingQuickFix(String displayString, String imageKey, Collection<EObject> contextObjects, Resource resource) {
		super();
	...
	public String apply(String currentText) {
		...
		try {
			...
			new eu.hyvar.feature.mapping.resource.hymapping.util.HymappingRuntimeUtil().logError("Exception while applying quick fix", e);
		}
		return null;
	}

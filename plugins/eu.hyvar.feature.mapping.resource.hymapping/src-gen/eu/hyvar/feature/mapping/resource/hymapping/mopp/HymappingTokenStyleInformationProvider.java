...
public class HymappingTokenStyleInformationProvider {
	...
	public eu.hyvar.feature.mapping.resource.hymapping.IHymappingTokenStyle getDefaultTokenStyle(String tokenName) {
		if ("SL_COMMENT".equals(tokenName)) {
			return new eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingTokenStyle(new int[] {0x00, 0x80, 0x00}, null, false, false, false, false);
		}
		if ("ML_COMMENT".equals(tokenName)) {
			return new eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingTokenStyle(new int[] {0x00, 0x80, 0x00}, null, false, false, false, false);
		}
		if ("<->".equals(tokenName)) {
			return new eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingTokenStyle(new int[] {0x80, 0x00, 0x40}, null, true, false, false, false);
		}
		if ("->".equals(tokenName)) {
			return new eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingTokenStyle(new int[] {0x80, 0x00, 0x40}, null, true, false, false, false);
		}
		...
		if ("[".equals(tokenName)) {
			return new eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingTokenStyle(new int[] {0x00, 0x00, 0xCC}, null, false, false, false, false);
		}
		if ("]".equals(tokenName)) {
			return new eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingTokenStyle(new int[] {0x00, 0x00, 0xCC}, null, false, false, false, false);
		}

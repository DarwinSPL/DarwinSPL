...
public class HymappingNature implements IProjectNature {
	
	public static final String NATURE_ID = "eu.hyvar.feature.mapping.resource.hymapping.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}

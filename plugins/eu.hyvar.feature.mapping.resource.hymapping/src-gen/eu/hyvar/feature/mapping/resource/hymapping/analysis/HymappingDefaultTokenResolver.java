 ...
 * </p>
 */
public class HymappingDefaultTokenResolver implements eu.hyvar.feature.mapping.resource.hymapping.IHymappingTokenResolver {
	 ...
	 */
	public HymappingDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public HymappingDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, EStructuralFeature feature, eu.hyvar.feature.mapping.resource.hymapping.IHymappingTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : eu.hyvar.feature.mapping.resource.hymapping.grammar.HymappingGrammarInformationProvider.INSTANCE.getKeywords()) {

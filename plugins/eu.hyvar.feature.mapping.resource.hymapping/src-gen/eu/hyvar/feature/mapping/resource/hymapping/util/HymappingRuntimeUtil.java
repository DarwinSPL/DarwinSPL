 ...
 */
public class HymappingRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {

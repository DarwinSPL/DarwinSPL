...
public abstract class HymappingANTLRParserBase extends Parser implements eu.hyvar.feature.mapping.resource.hymapping.IHymappingTextParser {
	 ...
	 * result object.
	 */
	protected Collection<eu.hyvar.feature.mapping.resource.hymapping.IHymappingCommand<eu.hyvar.feature.mapping.resource.hymapping.IHymappingTextResource>> postParseCommands;
	 ...
	 */
	private eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingTokenResolveResult tokenResolveResult = new eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingTokenResolveResult();
	...
	public HymappingANTLRParserBase(TokenStream input) {
		super(input);
	}
	
	public HymappingANTLRParserBase(TokenStream input, RecognizerSharedState state) {
		super(input, state);
	}
	
	protected void retrieveLayoutInformation(EObject element, eu.hyvar.feature.mapping.resource.hymapping.grammar.HymappingSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		isElementToStore |= syntaxElement instanceof eu.hyvar.feature.mapping.resource.hymapping.grammar.HymappingPlaceholder;
		isElementToStore |= syntaxElement instanceof eu.hyvar.feature.mapping.resource.hymapping.grammar.HymappingKeyword;
		isElementToStore |= syntaxElement instanceof eu.hyvar.feature.mapping.resource.hymapping.grammar.HymappingEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof eu.hyvar.feature.mapping.resource.hymapping.grammar.HymappingBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
		...
		layoutInformationAdapter.addLayoutInformation(new eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingLayoutInformation(syntaxElement, object, offset, hiddenTokenText.toString(), visibleTokenText.toString()));
	...
	protected <ContainerType extends EObject, ReferenceType extends EObject> void registerContextDependentProxy(final eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingContextDependentURIFragmentFactory<ContainerType, ReferenceType> factory, final ContainerType container, final EReference reference, final String id, final EObject proxy) {
		final int position;
		if (reference.isMany()) {
	...
	protected void addMapEntry(EObject element, EStructuralFeature structuralFeature, eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingDummyEObject dummy) {
		Object value = element.eGet(structuralFeature);
		Object mapKey = dummy.getValueByName("key");
		Object mapValue = dummy.getValueByName("value");
		if (value instanceof EMap<?, ?>) {
			EMap<Object, Object> valueMap = eu.hyvar.feature.mapping.resource.hymapping.util.HymappingMapUtil.castToEMap(value);
	...
	protected EObject apply(EObject target, List<EObject> dummyEObjects) {
		...
		for (EObject object : dummyEObjects) {
			assert(object instanceof eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingDummyEObject);
			eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingDummyEObject dummy = (eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingDummyEObject) object;
	...
	protected eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingTokenResolveResult getFreshTokenResolveResult() {
	...
	protected eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingReferenceResolverSwitch getReferenceResolverSwitch() {
		eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingReferenceResolverSwitch resolverSwitch = (eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingReferenceResolverSwitch) metaInformation.getReferenceResolverSwitch();
	...
	public boolean isLayoutInformationRecordingEnabled() {
		...
		Object value = options.get(eu.hyvar.feature.mapping.resource.hymapping.IHymappingOptions.DISABLE_LAYOUT_INFORMATION_RECORDING);
	...
	public boolean isLocationMapEnabled() {
		...
		Object value = options.get(eu.hyvar.feature.mapping.resource.hymapping.IHymappingOptions.DISABLE_LOCATION_MAP);
		return value == null || Boolean.FALSE.equals(value);
	}

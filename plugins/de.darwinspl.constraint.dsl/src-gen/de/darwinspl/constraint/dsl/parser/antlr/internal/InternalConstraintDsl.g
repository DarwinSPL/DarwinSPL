...
entryRuleHyConstraintModel returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getHyConstraintModelRule()); }
	iv_ruleHyConstraintModel=ruleHyConstraintModel
	{ $current=$iv_ruleHyConstraintModel.current; }
	EOF;

// Rule HyConstraintModel
ruleHyConstraintModel returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleHyConstraint returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getHyConstraintRule()); }
	iv_ruleHyConstraint=ruleHyConstraint
	{ $current=$iv_ruleHyConstraint.current; }
	EOF;

// Rule HyConstraint
ruleHyConstraint returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_HyAttributeReferenceExpression_3.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleHyNestedArithmeticalValueExpression returns [EObject current=null]:
	...
	{ $current=$iv_ruleHyNestedArithmeticalValueExpression.current; }
	EOF;

// Rule HyNestedArithmeticalValueExpression
ruleHyNestedArithmeticalValueExpression returns [EObject current=null]
@init {
	enterRule();
}
@after {

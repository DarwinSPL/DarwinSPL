 ...
 * instance of HyexpressionDefaultTokenResolver which performs a standard
 * conversion based on the EMF type conversion. This includes conversion of
 * registered EDataTypes.
 * </p>
 * 
 * @see
 * eu.hyvar.feature.expression.resource.hyexpression.analysis.HyexpressionDefaultTo
 * kenResolver
 */
public interface IHyexpressionTokenResolver extends eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionConfigurable {

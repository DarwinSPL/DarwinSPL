...
public class HyexpressionNature implements IProjectNature {
	
	public static final String NATURE_ID = "eu.hyvar.feature.expression.resource.hyexpression.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}

...
public abstract class HyexpressionANTLRParserBase extends Parser implements eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionTextParser {
	 ...
	 * result object.
	 */
	protected Collection<eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionCommand<eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionTextResource>> postParseCommands;
	 ...
	 */
	private eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionTokenResolveResult tokenResolveResult = new eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionTokenResolveResult();
	...
	public HyexpressionANTLRParserBase(TokenStream input) {
		super(input);
	}
	
	public HyexpressionANTLRParserBase(TokenStream input, RecognizerSharedState state) {
		super(input, state);
	}
	
	protected void retrieveLayoutInformation(EObject element, eu.hyvar.feature.expression.resource.hyexpression.grammar.HyexpressionSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		isElementToStore |= syntaxElement instanceof eu.hyvar.feature.expression.resource.hyexpression.grammar.HyexpressionPlaceholder;
		isElementToStore |= syntaxElement instanceof eu.hyvar.feature.expression.resource.hyexpression.grammar.HyexpressionKeyword;
		isElementToStore |= syntaxElement instanceof eu.hyvar.feature.expression.resource.hyexpression.grammar.HyexpressionEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof eu.hyvar.feature.expression.resource.hyexpression.grammar.HyexpressionBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
		...
		layoutInformationAdapter.addLayoutInformation(new eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionLayoutInformation(syntaxElement, object, offset, hiddenTokenText.toString(), visibleTokenText.toString()));
	...
	protected <ContainerType extends EObject, ReferenceType extends EObject> void registerContextDependentProxy(final eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionContextDependentURIFragmentFactory<ContainerType, ReferenceType> factory, final ContainerType container, final EReference reference, final String id, final EObject proxy) {
		final int position;
		if (reference.isMany()) {
	...
	protected void addMapEntry(EObject element, EStructuralFeature structuralFeature, eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionDummyEObject dummy) {
		Object value = element.eGet(structuralFeature);
		Object mapKey = dummy.getValueByName("key");
		Object mapValue = dummy.getValueByName("value");
		if (value instanceof EMap<?, ?>) {
			EMap<Object, Object> valueMap = eu.hyvar.feature.expression.resource.hyexpression.util.HyexpressionMapUtil.castToEMap(value);
	...
	protected EObject apply(EObject target, List<EObject> dummyEObjects) {
		...
		for (EObject object : dummyEObjects) {
			assert(object instanceof eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionDummyEObject);
			eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionDummyEObject dummy = (eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionDummyEObject) object;
	...
	protected eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionTokenResolveResult getFreshTokenResolveResult() {
	...
	protected eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionReferenceResolverSwitch getReferenceResolverSwitch() {
		eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionReferenceResolverSwitch resolverSwitch = (eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionReferenceResolverSwitch) metaInformation.getReferenceResolverSwitch();
	...
	public boolean isLayoutInformationRecordingEnabled() {
		...
		Object value = options.get(eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionOptions.DISABLE_LAYOUT_INFORMATION_RECORDING);
	...
	public boolean isLocationMapEnabled() {
		...
		Object value = options.get(eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionOptions.DISABLE_LOCATION_MAP);
		return value == null || Boolean.FALSE.equals(value);
	}

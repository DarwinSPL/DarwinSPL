...
/**
 * <p>
 * HyexpressionLayoutInformation objects are used to store layout information that
 ...
 * </p>
 * <p>
 * HyexpressionLayoutInformations are aggregated in LayoutInformationAdapters. One
 * HyexpressionLayoutInformation contains the layout that was found before a
 * keyword, attribute or reference.
 * </p>
 */
public class HyexpressionLayoutInformation {
	 ...
	 */
	private final eu.hyvar.feature.expression.resource.hyexpression.grammar.HyexpressionSyntaxElement syntaxElement;
	...
	public HyexpressionLayoutInformation(eu.hyvar.feature.expression.resource.hyexpression.grammar.HyexpressionSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();

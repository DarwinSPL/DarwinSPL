 ...
 * </p>
 */
public class HyexpressionDefaultTokenResolver implements eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionTokenResolver {
	 ...
	 */
	public HyexpressionDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public HyexpressionDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, EStructuralFeature feature, eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : eu.hyvar.feature.expression.resource.hyexpression.grammar.HyexpressionGrammarInformationProvider.INSTANCE.getKeywords()) {

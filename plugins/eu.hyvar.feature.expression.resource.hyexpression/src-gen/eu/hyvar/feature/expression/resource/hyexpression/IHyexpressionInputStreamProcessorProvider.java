 ...
 * conversion.
 */
public interface IHyexpressionInputStreamProcessorProvider {
	 ...
	 */
	public eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionInputStreamProcessor getInputStreamProcessor(InputStream inputStream);
}

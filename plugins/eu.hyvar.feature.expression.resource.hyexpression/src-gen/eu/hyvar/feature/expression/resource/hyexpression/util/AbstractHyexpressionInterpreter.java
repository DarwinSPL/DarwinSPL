 ...
 */
public class AbstractHyexpressionInterpreter<ResultType, ContextType> {
	
	private Stack<EObject> interpretationStack = new Stack<EObject>();
	private List<eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionInterpreterListener> listeners = new ArrayList<eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionInterpreterListener>();
	...
	private void notifyListeners(EObject element) {
		for (eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionInterpreterListener listener : listeners) {
	...
	public void addListener(eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionInterpreterListener newListener) {
		listeners.add(newListener);
	}
	
	public boolean removeListener(eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionInterpreterListener listener) {

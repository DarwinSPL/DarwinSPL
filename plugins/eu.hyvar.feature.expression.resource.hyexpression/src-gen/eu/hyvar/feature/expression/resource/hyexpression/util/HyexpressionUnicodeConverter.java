 ...
 * to 4 bytes).
 */
public class HyexpressionUnicodeConverter extends eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionInputStreamProcessor {
	 ...
	 */
	public HyexpressionUnicodeConverter(InputStream inputStream) {

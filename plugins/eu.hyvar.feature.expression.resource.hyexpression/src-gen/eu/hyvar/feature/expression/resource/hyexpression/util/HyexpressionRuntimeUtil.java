 ...
 */
public class HyexpressionRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {

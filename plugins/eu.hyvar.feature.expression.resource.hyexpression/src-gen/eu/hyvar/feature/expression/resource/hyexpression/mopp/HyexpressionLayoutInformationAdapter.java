...
/**
 * <p>
 * A HyexpressionLayoutInformationAdapter is used to store layout information that
 ...
 * HyexpressionLayoutInformationAdapters are attached to EObjects and aggregate
 ...
 * </p>
 */
public class HyexpressionLayoutInformationAdapter implements Adapter {
	 ...
	 * reference.
	 */
	private List<eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionLayoutInformation> layoutInformations = new ArrayList<eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionLayoutInformation>();
	...
	public List<eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionLayoutInformation layoutInformation) {

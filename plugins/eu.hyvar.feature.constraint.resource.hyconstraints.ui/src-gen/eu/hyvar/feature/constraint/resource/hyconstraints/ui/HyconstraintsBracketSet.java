 ...
 */
public class HyconstraintsBracketSet {
	...
	private ArrayList<eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsBracketPair> bracketPairs;
	private String languageID;
	
	/**
	 * Creates a new bracket set to manage bracket pairs.
	 */
	public HyconstraintsBracketSet() {
		super();
		this.languageID = new eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsMetaInformation().getSyntaxName();
		this.bracketPairs = new ArrayList<eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsBracketPair>();
	}
	...
	public eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsBracketPair getBracketPair(String opening, String closing) {
		for (eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsBracketPair bracketPair : bracketPairs) {
	...
	public boolean addBracketPair(String opening, String closing, boolean closingEnabledInside, boolean closeAfterEnter) {
		...
		bracketPairs.add(new eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsBracketPair(opening, closing, closingEnabledInside, closeAfterEnter));
		return true;
	}
	...
	public boolean resetBrackets(IPreferenceStore preferenceStore) {
		String bracketPairs = preferenceStore.getString(languageID + eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsBracketPair remove(String opening, String closing) {
		for (eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public void deserialize(String bracketSet) {
		bracketPairs = new ArrayList<eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsBracketPair>();
	...
	public void highlightBrackets(IDocument document, int position, int caretOffset) {
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}

 ...
 */
public class HyconstraintsHighlighting implements ISelectionProvider, ISelectionChangedListener {
	...
	private eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsOccurrence occurrence;
	private eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsBackgroundParsingListener {
	...
	private void addListeners(eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsEditor editor) {
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsPositionCategory.BRACKET.toString());
	}
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsEObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		isHighlightBrackets = preferenceStore.getBoolean(eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));

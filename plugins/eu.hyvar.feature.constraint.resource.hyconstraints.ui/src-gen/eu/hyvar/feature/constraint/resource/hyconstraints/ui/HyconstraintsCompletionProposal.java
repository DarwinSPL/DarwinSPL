 ...
 */
public class HyconstraintsCompletionProposal implements Comparable<HyconstraintsCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsExpectedTerminal expectedTerminal;
	...
	public HyconstraintsCompletionProposal(eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public HyconstraintsCompletionProposal(eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public HyconstraintsCompletionProposal(eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof HyconstraintsCompletionProposal) {
			HyconstraintsCompletionProposal other = (HyconstraintsCompletionProposal) object;
	...
	public int compareTo(HyconstraintsCompletionProposal object) {
		if (object instanceof HyconstraintsCompletionProposal) {
			HyconstraintsCompletionProposal other = (HyconstraintsCompletionProposal) object;

...
public class HyconstraintsMarkerAnnotation extends MarkerAnnotation implements IQuickFixableAnnotation {
	
	// private boolean isQuickFixable;
	
	public HyconstraintsMarkerAnnotation(IMarker marker) {
		super(marker);
	}

 ...
 * a specified depth.
 */
public class HyconstraintsOutlinePageTreeViewer extends TreeViewer {
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsPlugin.logError("Exception while refreshing outline view", e);
		}
	}

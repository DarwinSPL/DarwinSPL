 ...
 * </p>
 */
public class HyconstraintsSyntaxColoringPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public HyconstraintsSyntaxColoringPreferencePage() {
		super();
		
		eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsMetaInformation metaInformation = new eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsMetaInformation();
		...
		setPreferenceStore(eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsUIPlugin.getDefault().getPreferenceStore());
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(Composite composite, int horizontalSpan) {
		eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsPixelConverter pixelConverter = new eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsEditor) {
			eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsEditor emfTextEditor = (eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsEditor) editor;

 ...
 */
public class HyconstraintsUIPlugin extends AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "eu.hyvar.feature.constraint.resource.hyconstraints.ui";
	public static final String EDITOR_ID = "eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsEditor";
	...
	private static HyconstraintsUIPlugin plugin;
	
	public HyconstraintsUIPlugin() {
		super();
	}
	...
	public static HyconstraintsUIPlugin getDefault() {
		return plugin;
	}
	...
	protected static IStatus log(int type, String message, Throwable throwable) {
		IStatus status;
		if (throwable != null) {
			status = new Status(type, HyconstraintsUIPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new Status(type, HyconstraintsUIPlugin.PLUGIN_ID, message);
		}
		final HyconstraintsUIPlugin pluginInstance = HyconstraintsUIPlugin.getDefault();

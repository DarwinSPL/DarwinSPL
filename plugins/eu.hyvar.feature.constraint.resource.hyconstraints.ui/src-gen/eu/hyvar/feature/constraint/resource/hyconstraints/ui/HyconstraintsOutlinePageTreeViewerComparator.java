...
public class HyconstraintsOutlinePageTreeViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof EObject && o2 instanceof EObject) {
			...
			eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsNameProvider nameProvider = new eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsMetaInformation().createNameProvider();

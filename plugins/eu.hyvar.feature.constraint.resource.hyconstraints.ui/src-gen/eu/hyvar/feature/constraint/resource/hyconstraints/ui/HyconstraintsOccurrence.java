 ...
 */
public class HyconstraintsOccurrence {
	
	private static interface ITokenScannerConstraint {
		public boolean mustStop(eu.hyvar.feature.constraint.resource.hyconstraints.ui.IHyconstraintsTokenScanner tokenScanner);
	}
	
	public final static String OCCURRENCE_ANNOTATION_ID = "eu.hyvar.feature.constraint.resource.hyconstraints.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "eu.hyvar.feature.constraint.resource.hyconstraints.ui.occurences.declaration";
	
	private final static eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsPositionHelper positionHelper = new eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsPositionHelper();
	 ...
	 */
	private eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsTextResource textResource;
	...
	/**
	 * <p>
	 * Creates a HyconstraintsOccurrence object to find positions to highlight.
	 * </p>
	 * 
	 * @param textResource the text resource for location
	 * @param projectionViewer the viewer for the text
	 */
	public HyconstraintsOccurrence(eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsTextResource textResource, ProjectionViewer projectionViewer) {
		super();
	...
	protected int getLength(eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsLocationMap locationMap, EObject eObject) {
	...
	public void updateOccurrenceAnnotations() {
		...
		eu.hyvar.feature.constraint.resource.hyconstraints.ui.IHyconstraintsTokenScanner tokenScanner = scan(referencedElement, new ITokenScannerConstraint() {
	...
	protected List<String> addAnnotationsForDefinition(EObject referencedElement, String definitionText, int definitionOffset, final int caretOffset) {
		...
		if (definitionText == null) {
			...
			final List<String> names = new eu.hyvar.feature.constraint.resource.hyconstraints.analysis.HyconstraintsDefaultNameProvider().getNames(referencedElement);
			scan(referencedElement, new ITokenScannerConstraint() {
				...
				public boolean mustStop(eu.hyvar.feature.constraint.resource.hyconstraints.ui.IHyconstraintsTokenScanner tokenScanner) {
					...
					if (names.contains(text) && isContainedIn(offset, length, caretOffset)) {
						...
						addAnnotation(document, eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsPositionCategory.DEFINITION, text, offset, text.length());
					}
					return false;
				}
			});
			...
			addAnnotation(document, eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsPositionCategory.DEFINITION, definitionText, definitionOffset, definitionText.length());
	...
	protected int getIndexOf(EObject eObject, final String text) {
		eu.hyvar.feature.constraint.resource.hyconstraints.ui.IHyconstraintsTokenScanner tokenScanner = scan(eObject, new ITokenScannerConstraint() {
	...
	protected eu.hyvar.feature.constraint.resource.hyconstraints.ui.IHyconstraintsTokenScanner scan(EObject object, ITokenScannerConstraint constraint) {
		IDocument document = getSourceViewer().getDocument();
		
		eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsLocationMap locationMap = textResource.getLocationMap();
		
		eu.hyvar.feature.constraint.resource.hyconstraints.ui.IHyconstraintsTokenScanner tokenScanner = createTokenScanner();
	...
	protected eu.hyvar.feature.constraint.resource.hyconstraints.ui.IHyconstraintsTokenScanner createTokenScanner() {
		return new eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsUIMetaInformation().createTokenScanner(null, null);
	}
	...
	protected void removeAnnotations() {
		removeAnnotations(eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsOccurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsOccurrence.DECLARATION_ANNOTATION_ID);
	}

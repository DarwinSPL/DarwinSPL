 ...
 */
public class HyconstraintsTextHover implements ITextHover, ITextHoverExtension, ITextHoverExtension2 {
	...
	private eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends Action {
		...
		private final eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsDocBrowserInformationControlInput infoInput = (eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsHyperlink hyperlink = new eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	 ...
	 */
	public HyconstraintsTextHover(eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
		...
		return ((eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsDocBrowserInformationControlInput internalGetHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
	 ...
	 */
	private eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsDocBrowserInformationControlInput getHoverInfo(List<EObject> elements, ITextViewer textViewer, eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsHTMLPrinter.insertPageProlog(buffer, 0, eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsTextHover.getStyleSheet());
			eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsHTMLPrinter.addPageEpilog(buffer);
			return new eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		Bundle bundle = Platform.getBundle(eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsUIPlugin.PLUGIN_ID);
		URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return eu.hyvar.feature.constraint.resource.hyconstraints.util.HyconstraintsStreamUtil.getContent(styleSheetURL.openStream());

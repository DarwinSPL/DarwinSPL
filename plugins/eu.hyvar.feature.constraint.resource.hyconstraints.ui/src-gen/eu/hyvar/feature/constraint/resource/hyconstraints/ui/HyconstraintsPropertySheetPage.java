...
public class HyconstraintsPropertySheetPage extends PropertySheetPage implements ISelectionChangedListener {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection iSelection) {
		...
		if (iSelection instanceof eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsEObjectSelection) {
			final eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsEObjectSelection selection = (eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsEObjectSelection) iSelection;

 ...
 * </p>
 */
public class HyconstraintsBracketPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsMetaInformation().getSyntaxName();
	
	private eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public HyconstraintsBracketPreferencePage() {
		super();
		
		eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsMetaInformation metaInformation = new eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsMetaInformation();
	...
	public void init(IWorkbench workbench) {
		...
		bracketsTmp = new eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsBracketSet();
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void addListenersToStyleButtons() {
		...
		bracketsList.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsBracketPair bracketPair = getSelectedBracketPair();
				if (bracketPair == null) {
					removeBracketButton.setEnabled(false);
					return;
				}
	...
	protected void performDefaults() {
		...
		String defaultBrackets = preferenceStore.getDefaultString(language + eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	protected eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsBracketPair getSelectedBracketPair() {

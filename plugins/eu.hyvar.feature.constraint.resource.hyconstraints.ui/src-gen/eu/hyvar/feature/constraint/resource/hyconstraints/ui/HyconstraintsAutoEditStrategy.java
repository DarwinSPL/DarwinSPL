...
/**
 * The HyconstraintsAutoEditStrategy extends the default auto edit strategy such
 ...
 */
public class HyconstraintsAutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	
	private eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsBracketSet bracketSet;
	
	public HyconstraintsAutoEditStrategy() {
		super();
		...
		if (plugin != null) {
			...
			bracketSet = new eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsBracketSet();
	 ...
	 */
	@Deprecated
	public void setBracketSet(eu.hyvar.feature.constraint.resource.hyconstraints.ui.HyconstraintsBracketSet bracketSet) {

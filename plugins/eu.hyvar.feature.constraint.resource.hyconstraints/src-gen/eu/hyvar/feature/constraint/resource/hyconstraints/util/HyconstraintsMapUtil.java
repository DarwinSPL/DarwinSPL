...
public class HyconstraintsMapUtil {
	...
	public static <K> void putAndMergeKeys(Map<K, Object> map, K key, Object value) {
		...
		if (map.containsKey(key)) {
			...
			if (currentValue instanceof List<?>) {
				...
				List<Object> currentValueAsObjectList = eu.hyvar.feature.constraint.resource.hyconstraints.util.HyconstraintsListUtil.copySafelyToObjectList(currentValueAsList);

 ...
 */
public class HyconstraintsBracketPair implements eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsBracketPair {
	...
	public HyconstraintsBracketPair(String openingBracket, String closingBracket, boolean closingEnabledInside, boolean closeAfterEnter) {
		super();
		this.openingBracket = openingBracket;
		this.closingBracket = closingBracket;
		this.closingEnabledInside = closingEnabledInside;

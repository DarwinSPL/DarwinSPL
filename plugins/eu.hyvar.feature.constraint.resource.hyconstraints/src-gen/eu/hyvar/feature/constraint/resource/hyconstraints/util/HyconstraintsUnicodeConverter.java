 ...
 * to 4 bytes).
 */
public class HyconstraintsUnicodeConverter extends eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsInputStreamProcessor {
	 ...
	 */
	public HyconstraintsUnicodeConverter(InputStream inputStream) {

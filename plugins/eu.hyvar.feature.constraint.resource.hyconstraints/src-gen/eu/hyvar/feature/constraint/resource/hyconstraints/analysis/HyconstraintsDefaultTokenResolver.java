 ...
 * </p>
 */
public class HyconstraintsDefaultTokenResolver implements eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsTokenResolver {
	 ...
	 */
	public HyconstraintsDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public HyconstraintsDefaultTokenResolver(boolean escapeKeywords) {
		super();
		this.escapeKeywords = escapeKeywords;
	}
	
	public void resolve(String lexem, EStructuralFeature feature, eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsTokenResolveResult result) {
		resolve(lexem, feature, result, null, null, null);
	}
	
	public void resolve(String lexem, EStructuralFeature feature, eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : eu.hyvar.feature.constraint.resource.hyconstraints.grammar.HyconstraintsGrammarInformationProvider.INSTANCE.getKeywords()) {

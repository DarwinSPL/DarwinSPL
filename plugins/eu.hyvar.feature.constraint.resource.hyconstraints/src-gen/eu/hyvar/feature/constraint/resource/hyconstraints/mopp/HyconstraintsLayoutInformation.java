...
/**
 * <p>
 * HyconstraintsLayoutInformation objects are used to store layout information
 ...
 * </p>
 * <p>
 * HyconstraintsLayoutInformations are aggregated in LayoutInformationAdapters.
 * One HyconstraintsLayoutInformation contains the layout that was found before a
 * keyword, attribute or reference.
 * </p>
 */
public class HyconstraintsLayoutInformation {
	 ...
	 */
	private final eu.hyvar.feature.constraint.resource.hyconstraints.grammar.HyconstraintsSyntaxElement syntaxElement;
	...
	public HyconstraintsLayoutInformation(eu.hyvar.feature.constraint.resource.hyconstraints.grammar.HyconstraintsSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();

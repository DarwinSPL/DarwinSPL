 ...
 */
public class HyconstraintsEnumerationTerminal extends eu.hyvar.feature.constraint.resource.hyconstraints.grammar.HyconstraintsTerminal {
	
	private Map<String, String> mapping = new LinkedHashMap<String, String>();
	
	public HyconstraintsEnumerationTerminal(EStructuralFeature attribute, String[] literalMappings, eu.hyvar.feature.constraint.resource.hyconstraints.grammar.HyconstraintsCardinality cardinality, int mandatoryOccurrencesAfter) {

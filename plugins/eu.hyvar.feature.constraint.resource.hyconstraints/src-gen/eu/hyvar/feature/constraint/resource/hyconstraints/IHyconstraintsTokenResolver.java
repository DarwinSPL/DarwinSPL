 ...
 * instance of HyconstraintsDefaultTokenResolver which performs a standard
 * conversion based on the EMF type conversion. This includes conversion of
 * registered EDataTypes.
 * </p>
 * 
 * @see
 * eu.hyvar.feature.constraint.resource.hyconstraints.analysis.HyconstraintsDefault
 * TokenResolver
 */
public interface IHyconstraintsTokenResolver extends eu.hyvar.feature.constraint.resource.hyconstraints.IHyconstraintsConfigurable {

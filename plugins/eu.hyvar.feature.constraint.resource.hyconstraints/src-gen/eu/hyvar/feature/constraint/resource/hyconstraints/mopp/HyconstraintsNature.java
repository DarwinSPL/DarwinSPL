...
public class HyconstraintsNature implements IProjectNature {
	
	public static final String NATURE_ID = "eu.hyvar.feature.constraint.resource.hyconstraints.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}

 ...
 */
public class HyconstraintsRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			eu.hyvar.feature.constraint.resource.hyconstraints.mopp.HyconstraintsPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {

 ...
 * @since 3.2
 */
public class HycontextinformationBrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	...
	private eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationDocBrowserInformationControlInput fInput;
	 ...
	 */
	public HycontextinformationBrowserInformationControl(Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public HycontextinformationBrowserInformationControl(Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public HycontextinformationBrowserInformationControl(Shell parent, String symbolicFontName, ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		Assert.isLegal(input == null || input instanceof String || input instanceof eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationDocBrowserInformationControlInput);
		...
		fInput= (eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationDocBrowserInformationControlInput) input;
		...
		eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationHTMLPrinter.insertStyles(buffer, styles);
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationHTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}
	 ...
	 */
	public eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationDocBrowserInformationControlInput getInput() {
		return fInput;
	}

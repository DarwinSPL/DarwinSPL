...
public class HycontextinformationToggleCommentHandler extends AbstractHandler {
	...
	public boolean isEnabled() {
		...
		if (activeEditor instanceof eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEditor) {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEditor editor = null;
		
		if (editorPart instanceof eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEditor) {
			editor = (eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEditor) editorPart;

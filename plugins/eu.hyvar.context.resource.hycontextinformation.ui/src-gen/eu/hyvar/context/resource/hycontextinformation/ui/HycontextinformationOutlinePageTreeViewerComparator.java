...
public class HycontextinformationOutlinePageTreeViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof EObject && o2 instanceof EObject) {
			...
			eu.hyvar.context.resource.hycontextinformation.IHycontextinformationNameProvider nameProvider = new eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationMetaInformation().createNameProvider();

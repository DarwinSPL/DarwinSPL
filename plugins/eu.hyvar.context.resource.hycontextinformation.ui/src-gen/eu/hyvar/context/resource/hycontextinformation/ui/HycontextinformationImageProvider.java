 ...
 */
public class HycontextinformationImageProvider {
	
	public final static HycontextinformationImageProvider INSTANCE = new HycontextinformationImageProvider();
	...
	public ImageDescriptor getImageDescriptor(String key) {
		...
		if (ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
		return descriptor;
	}

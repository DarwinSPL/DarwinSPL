 ...
 */
public class HycontextinformationHighlighting implements ISelectionProvider, ISelectionChangedListener {
	...
	private eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEditor editor;
	private ProjectionViewer projectionViewer;
	private eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationOccurrence occurrence;
	private eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, eu.hyvar.context.resource.hycontextinformation.IHycontextinformationBackgroundParsingListener {
	 ...
	 */
	public HycontextinformationHighlighting(eu.hyvar.context.resource.hycontextinformation.IHycontextinformationTextResource textResource, ProjectionViewer projectionViewer, eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationColorManager colorManager, eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEditor editor) {
		this.display = Display.getCurrent();
		projectionViewer.getSelectionProvider();
		this.preferenceStore = eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		this.textWidget = projectionViewer.getTextWidget();
		this.projectionViewer = projectionViewer;
		this.occurrence = new eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationOccurrence(textResource, projectionViewer);
		this.bracketSet = new eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationBracketSet();
		this.colorManager = colorManager;
		this.isHighlightBrackets = preferenceStore.getBoolean(eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		this.bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		this.black = colorManager.getColor(new RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEditor editor) {
	...
	private void setBracketHighlighting(IDocument document) {
		...
		Position[] positions = positionHelper.getPositions(document, eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(IDocument document, String category) {
		...
		if (category.equals(eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		isHighlightBrackets = preferenceStore.getBoolean(eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));

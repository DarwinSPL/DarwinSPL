 ...
 * </p>
 */
public class HycontextinformationNewProjectWizard extends Wizard implements INewWizard, IExecutableExtension {
	
	/**
	 * The name of the ZIP file that is used as content for the new project (relative
	 * to the root of the resource UI plug-in).
	 */
	public final static String NEW_PROJECT_ZIP_FILE_NAME = eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationUIResourceBundle.NEW_PROJECT_ZIP_FILE_NAME;
	 ...
	 */
	protected String pageName = eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_NAME;
	 ...
	 */
	protected String pageDescription = eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_DESCRIPTION;
	
	/**
	 * The name of the project in the project creation page
	 */
	protected String pageProjectName = eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationUIResourceBundle.NEW_PROJECT_WIZARD_PROJECT_NAME;
	 ...
	 * eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationNewProject
	 * WizardLogic.
	 */
	...
	protected void doPerformFinish(IProgressMonitor monitor) throws Exception {
		new eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationNewProjectWizardLogic().createExampleProject(monitor, wizardNewProjectCreationPage.getLocationPath(), wizardNewProjectCreationPage.getProjectName(), eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationUIPlugin.PLUGIN_ID, NEW_PROJECT_ZIP_FILE_NAME);
	}
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		IPath path = new Path(eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_ICON);
		Bundle bundle = eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationUIPlugin.getDefault().getBundle();
		...
		setWindowTitle(eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationUIResourceBundle.NEW_PROJECT_WIZARD_WINDOW_TITLE);
	}

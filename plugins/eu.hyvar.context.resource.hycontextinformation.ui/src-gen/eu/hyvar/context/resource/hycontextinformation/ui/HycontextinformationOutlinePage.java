 ...
 */
public class HycontextinformationOutlinePage extends Page implements ISelectionProvider, ISelectionChangedListener, IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "eu.hyvar.context.resource.hycontextinformation.ui.outlinecontext";
	...
	public HycontextinformationOutlinePage(eu.hyvar.context.resource.hycontextinformation.IHycontextinformationResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(Composite parent) {
		treeViewer = new eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationOutlinePageTreeViewer(parent, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL);
				...
				if (viewer != null && viewer.getControl() != null && !viewer.getControl().isDisposed()) {
					viewerRefresh = new ViewerRefresh(viewer) {
						...
						protected void refresh(IViewerNotification notification) {
							if (viewer instanceof eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationOutlinePageTreeViewer) {
								eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationOutlinePageTreeViewer pageTreeViewer = (eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationOutlinePageTreeViewer) viewer;
		...
		treeViewer.setComparator(new eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("eu.hyvar.context.resource.hycontextinformation.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		List<IAction> actions = new eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationOutlinePageActionProvider().getActions(treeViewer);

 ...
 * olInput</code>.
 */
public class HycontextinformationDocBrowserInformationControlInput {
	
	private final HycontextinformationDocBrowserInformationControlInput fPrevious;
	private HycontextinformationDocBrowserInformationControlInput fNext;
	 ...
	 */
	public HycontextinformationDocBrowserInformationControlInput(HycontextinformationDocBrowserInformationControlInput previous, EObject element, Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public HycontextinformationDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public HycontextinformationDocBrowserInformationControlInput getNext() {
		return fNext;
	}

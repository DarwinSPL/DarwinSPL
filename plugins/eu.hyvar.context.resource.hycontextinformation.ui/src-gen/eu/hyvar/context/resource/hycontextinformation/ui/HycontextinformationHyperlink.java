 ...
 */
public class HycontextinformationHyperlink implements IHyperlink {
	 ...
	 */
	public HycontextinformationHyperlink(IRegion region, EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}

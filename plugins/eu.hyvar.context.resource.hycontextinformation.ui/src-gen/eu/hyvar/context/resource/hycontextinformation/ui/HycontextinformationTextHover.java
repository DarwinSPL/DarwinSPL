 ...
 */
public class HycontextinformationTextHover implements ITextHover, ITextHoverExtension, ITextHoverExtension2 {
	...
	private eu.hyvar.context.resource.hycontextinformation.IHycontextinformationHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends Action {
		...
		private final eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationDocBrowserInformationControlInput infoInput = (eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationHyperlink hyperlink = new eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends AbstractReusableInformationControlCreator {
		...
		public IInformationControl doCreateInformationControl(Shell parent) {
			if (eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationBrowserInformationControl.isAvailable(parent)) {
				ToolBarManager tbm = new ToolBarManager(SWT.FLAT);
				eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationBrowserInformationControl iControl = new eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationBrowserInformationControl(parent, FONT, tbm);
				...
				IInputChangedListener inputChangeListener = new IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationDocBrowserInformationControlInput) {
							eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationDocBrowserInformationControlInput input = (eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends AbstractReusableInformationControlCreator {
		...
		public IInformationControl doCreateInformationControl(Shell parent) {
			...
			if (eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationBrowserInformationControl.isAvailable(parent)) {
				eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationBrowserInformationControl iControl = new eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public HycontextinformationTextHover(eu.hyvar.context.resource.hycontextinformation.IHycontextinformationResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
		...
		return ((eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationDocBrowserInformationControlInput internalGetHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
	 ...
	 */
	private eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationDocBrowserInformationControlInput getHoverInfo(List<EObject> elements, ITextViewer textViewer, eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationHTMLPrinter.insertPageProlog(buffer, 0, eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationTextHover.getStyleSheet());
			eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationHTMLPrinter.addPageEpilog(buffer);
			return new eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		Bundle bundle = Platform.getBundle(eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationUIPlugin.PLUGIN_ID);
		URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return eu.hyvar.context.resource.hycontextinformation.util.HycontextinformationStreamUtil.getContent(styleSheetURL.openStream());

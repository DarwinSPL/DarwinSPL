...
/**
 * The HycontextinformationAutoEditStrategy extends the default auto edit strategy
 * such that an additional tab is added if a line break is entered after opening
 ...
 */
public class HycontextinformationAutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	
	private eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationBracketSet bracketSet;
	
	public HycontextinformationAutoEditStrategy() {
		super();
		...
		if (plugin != null) {
			...
			bracketSet = new eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationBracketSet();
	 ...
	 */
	@Deprecated
	public void setBracketSet(eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationBracketSet bracketSet) {

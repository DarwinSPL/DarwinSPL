 ...
 */
public class HycontextinformationBackgroundParsingStrategy {
	 ...
	 */
	public void parse(DocumentEvent event, final eu.hyvar.context.resource.hycontextinformation.IHycontextinformationTextResource resource, final eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(IDocument document, final eu.hyvar.context.resource.hycontextinformation.IHycontextinformationTextResource resource, final eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final eu.hyvar.context.resource.hycontextinformation.IHycontextinformationTextResource resource, final eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationResource) {
							eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationResource concreteResource = (eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationResource) resource;

 ...
 * a specified depth.
 */
public class HycontextinformationOutlinePageTreeViewer extends TreeViewer {
	...
	public HycontextinformationOutlinePageTreeViewer(Composite parent, int style) {
		super(parent, style);
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationPlugin.logError("Exception while refreshing outline view", e);
		}
	}

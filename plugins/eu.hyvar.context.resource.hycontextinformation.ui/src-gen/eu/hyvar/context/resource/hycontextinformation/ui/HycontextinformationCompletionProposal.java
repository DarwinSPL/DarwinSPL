 ...
 */
public class HycontextinformationCompletionProposal implements Comparable<HycontextinformationCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationExpectedTerminal expectedTerminal;
	...
	public HycontextinformationCompletionProposal(eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public HycontextinformationCompletionProposal(eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public HycontextinformationCompletionProposal(eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof HycontextinformationCompletionProposal) {
			HycontextinformationCompletionProposal other = (HycontextinformationCompletionProposal) object;
	...
	public int compareTo(HycontextinformationCompletionProposal object) {
		if (object instanceof HycontextinformationCompletionProposal) {
			HycontextinformationCompletionProposal other = (HycontextinformationCompletionProposal) object;

 ...
 * </p>
 */
public class HycontextinformationSyntaxColoringPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public HycontextinformationSyntaxColoringPreferencePage() {
		super();
		
		eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationMetaInformation metaInformation = new eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(Composite composite, int horizontalSpan) {
		eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationPixelConverter pixelConverter = new eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEditor) {
			eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEditor emfTextEditor = (eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEditor) editor;

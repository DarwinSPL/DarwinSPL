 ...
 */
public class HycontextinformationUIPlugin extends AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "eu.hyvar.context.resource.hycontextinformation.ui";
	public static final String EDITOR_ID = "eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEditor";
	...
	private static HycontextinformationUIPlugin plugin;
	
	public HycontextinformationUIPlugin() {
		super();
	}
	...
	public static HycontextinformationUIPlugin getDefault() {
		return plugin;
	}
	...
	protected static IStatus log(int type, String message, Throwable throwable) {
		IStatus status;
		if (throwable != null) {
			status = new Status(type, HycontextinformationUIPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new Status(type, HycontextinformationUIPlugin.PLUGIN_ID, message);
		}
		final HycontextinformationUIPlugin pluginInstance = HycontextinformationUIPlugin.getDefault();

...
public class HycontextinformationPropertySheetPage extends PropertySheetPage implements ISelectionChangedListener {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection iSelection) {
		...
		if (iSelection instanceof eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEObjectSelection) {
			final eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEObjectSelection selection = (eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationEObjectSelection) iSelection;

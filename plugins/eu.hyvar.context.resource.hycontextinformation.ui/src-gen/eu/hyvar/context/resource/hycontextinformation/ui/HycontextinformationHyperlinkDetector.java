 ...
 * hovers, is a proxy.
 */
public class HycontextinformationHyperlinkDetector implements IHyperlinkDetector {
	 ...
	 */
	public HycontextinformationHyperlinkDetector(Resource resource) {
		textResource = (eu.hyvar.context.resource.hycontextinformation.IHycontextinformationTextResource) resource;
	}
		...
		for (EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					IHyperlink hyperlink = new eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationHyperlink(new Region(offset, length), resolvedEObject, text);

 ...
 */
public class HycontextinformationPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public void init(IWorkbench workbench) {
		...
		setDescription(eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationUIResourceBundle.ROOT_PREFERENCE_PAGE_DESCRIPTION);
	}
	...
	protected Control createContents(Composite parent) {
		...
		link.setText(eu.hyvar.context.resource.hycontextinformation.ui.HycontextinformationUIResourceBundle.ROOT_PREFERENCE_PAGE_TEXT);
		link.setSize(140, 40);

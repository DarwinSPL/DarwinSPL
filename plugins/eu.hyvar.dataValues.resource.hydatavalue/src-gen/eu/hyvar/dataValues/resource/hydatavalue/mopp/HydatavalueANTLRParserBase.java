...
public abstract class HydatavalueANTLRParserBase extends Parser implements eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueTextParser {
	 ...
	 * result object.
	 */
	protected Collection<eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueCommand<eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueTextResource>> postParseCommands;
	 ...
	 */
	private eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueTokenResolveResult tokenResolveResult = new eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueTokenResolveResult();
	...
	public HydatavalueANTLRParserBase(TokenStream input) {
		super(input);
	}
	
	public HydatavalueANTLRParserBase(TokenStream input, RecognizerSharedState state) {
		super(input, state);
	}
	
	protected void retrieveLayoutInformation(EObject element, eu.hyvar.dataValues.resource.hydatavalue.grammar.HydatavalueSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		isElementToStore |= syntaxElement instanceof eu.hyvar.dataValues.resource.hydatavalue.grammar.HydatavaluePlaceholder;
		isElementToStore |= syntaxElement instanceof eu.hyvar.dataValues.resource.hydatavalue.grammar.HydatavalueKeyword;
		isElementToStore |= syntaxElement instanceof eu.hyvar.dataValues.resource.hydatavalue.grammar.HydatavalueEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof eu.hyvar.dataValues.resource.hydatavalue.grammar.HydatavalueBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
		eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueLayoutInformationAdapter layoutInformationAdapter = getLayoutInformationAdapter(element);
		...
		layoutInformationAdapter.addLayoutInformation(new eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueLayoutInformation(syntaxElement, object, offset, hiddenTokenText.toString(), visibleTokenText.toString()));
	...
	protected <ContainerType extends EObject, ReferenceType extends EObject> void registerContextDependentProxy(final eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueContextDependentURIFragmentFactory<ContainerType, ReferenceType> factory, final ContainerType container, final EReference reference, final String id, final EObject proxy) {
		final int position;
		if (reference.isMany()) {
	...
	protected void addMapEntry(EObject element, EStructuralFeature structuralFeature, eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueDummyEObject dummy) {
		Object value = element.eGet(structuralFeature);
		Object mapKey = dummy.getValueByName("key");
		Object mapValue = dummy.getValueByName("value");
		if (value instanceof EMap<?, ?>) {
			EMap<Object, Object> valueMap = eu.hyvar.dataValues.resource.hydatavalue.util.HydatavalueMapUtil.castToEMap(value);
	...
	protected EObject apply(EObject target, List<EObject> dummyEObjects) {
		...
		for (EObject object : dummyEObjects) {
			assert(object instanceof eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueDummyEObject);
			eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueDummyEObject dummy = (eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueDummyEObject) object;
	...
	protected eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueTokenResolveResult getFreshTokenResolveResult() {
	...
	protected eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueReferenceResolverSwitch getReferenceResolverSwitch() {
		eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueReferenceResolverSwitch resolverSwitch = (eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueReferenceResolverSwitch) metaInformation.getReferenceResolverSwitch();
	...
	public boolean isLayoutInformationRecordingEnabled() {
		...
		Object value = options.get(eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueOptions.DISABLE_LAYOUT_INFORMATION_RECORDING);
	...
	public boolean isLocationMapEnabled() {
		...
		Object value = options.get(eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueOptions.DISABLE_LOCATION_MAP);
		return value == null || Boolean.FALSE.equals(value);
	}

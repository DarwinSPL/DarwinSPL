...
public class HydatavalueNature implements IProjectNature {
	
	public static final String NATURE_ID = "eu.hyvar.dataValues.resource.hydatavalue.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}

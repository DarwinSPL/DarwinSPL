 ...
 * to 4 bytes).
 */
public class HydatavalueUnicodeConverter extends eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueInputStreamProcessor {
	 ...
	 */
	public HydatavalueUnicodeConverter(InputStream inputStream) {

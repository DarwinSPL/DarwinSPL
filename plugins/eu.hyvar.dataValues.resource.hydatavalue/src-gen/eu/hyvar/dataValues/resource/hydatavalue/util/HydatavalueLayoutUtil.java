 ...
 */
public class HydatavalueLayoutUtil {
	...
	public void transferLayoutInformationToModel(EObject element) {
		...
		for (Iterator<eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(EObject element) {
		...
		if (layoutReference != null) {
			...
			for (Iterator<EObject> i = list.iterator(); i.hasNext(); ) {
				...
				eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueLayoutInformation createLayoutInformation(EObject layoutInformationModelElement) {
		Object object = null;
		...
		eu.hyvar.dataValues.resource.hydatavalue.grammar.HydatavalueSyntaxElement syntaxElement = eu.hyvar.dataValues.resource.hydatavalue.grammar.HydatavalueGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof eu.hyvar.dataValues.resource.hydatavalue.grammar.HydatavaluePlaceholder) {
			eu.hyvar.dataValues.resource.hydatavalue.grammar.HydatavaluePlaceholder placeholder = (eu.hyvar.dataValues.resource.hydatavalue.grammar.HydatavaluePlaceholder) syntaxElement;
			eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueTokenResolver tokenResolver = new eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueTokenResolveResult result = new eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueLayoutInformationAdapter getLayoutInformationAdapter(EObject element) {
	...
	public void removeLayoutInformationAdapter(EObject element) {
		eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueLayoutInformationAdapter existingAdapter = getLayoutInformationAdapter(element);

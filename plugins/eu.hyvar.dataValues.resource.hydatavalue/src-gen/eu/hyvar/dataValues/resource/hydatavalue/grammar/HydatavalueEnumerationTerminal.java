 ...
 */
public class HydatavalueEnumerationTerminal extends eu.hyvar.dataValues.resource.hydatavalue.grammar.HydatavalueTerminal {
	
	private Map<String, String> mapping = new LinkedHashMap<String, String>();
	
	public HydatavalueEnumerationTerminal(EStructuralFeature attribute, String[] literalMappings, eu.hyvar.dataValues.resource.hydatavalue.grammar.HydatavalueCardinality cardinality, int mandatoryOccurrencesAfter) {

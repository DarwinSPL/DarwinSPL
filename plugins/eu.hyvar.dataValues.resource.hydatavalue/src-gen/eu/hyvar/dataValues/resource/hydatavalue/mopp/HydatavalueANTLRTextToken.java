...
public class HydatavalueANTLRTextToken extends eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueTextToken {
	
	private final static eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueMetaInformation metaInformation = new eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueMetaInformation();
	
	public HydatavalueANTLRTextToken(Token antlrToken) {

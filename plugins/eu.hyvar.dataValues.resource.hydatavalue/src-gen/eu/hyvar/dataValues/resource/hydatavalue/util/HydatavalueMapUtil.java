...
public class HydatavalueMapUtil {
	...
	public static <K> void putAndMergeKeys(Map<K, Object> map, K key, Object value) {
		...
		if (map.containsKey(key)) {
			...
			if (currentValue instanceof List<?>) {
				...
				List<Object> currentValueAsObjectList = eu.hyvar.dataValues.resource.hydatavalue.util.HydatavalueListUtil.copySafelyToObjectList(currentValueAsList);

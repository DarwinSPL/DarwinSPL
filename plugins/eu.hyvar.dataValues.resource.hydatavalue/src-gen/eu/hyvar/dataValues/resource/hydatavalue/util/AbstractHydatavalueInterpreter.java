 ...
 */
public class AbstractHydatavalueInterpreter<ResultType, ContextType> {
	
	private Stack<EObject> interpretationStack = new Stack<EObject>();
	private List<eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueInterpreterListener> listeners = new ArrayList<eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueInterpreterListener>();
	...
	private void notifyListeners(EObject element) {
		for (eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueInterpreterListener listener : listeners) {
	...
	public void addListener(eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueInterpreterListener newListener) {
		listeners.add(newListener);
	}
	
	public boolean removeListener(eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueInterpreterListener listener) {

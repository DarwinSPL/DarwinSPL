 ...
 */
public class HydatavalueBracketPair implements eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueBracketPair {
	...
	public HydatavalueBracketPair(String openingBracket, String closingBracket, boolean closingEnabledInside, boolean closeAfterEnter) {
		super();
		this.openingBracket = openingBracket;
		this.closingBracket = closingBracket;
		this.closingEnabledInside = closingEnabledInside;

...
public class HydatavalueTokenStyle implements eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueTokenStyle {
	...
	public HydatavalueTokenStyle(int[] colorAsRGB, int[] backgroundColorAsRGB, boolean bold, boolean italic, boolean striketrough, boolean underline) {
		super();
	...
	public HydatavalueTokenStyle(eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueTokenStyle styleToCopy) {
	...
	public boolean equals(Object obj) {
		...
		eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueTokenStyle other = (eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueTokenStyle) obj;

 ...
 */
public class HydatavalueRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavaluePlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavaluePlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {

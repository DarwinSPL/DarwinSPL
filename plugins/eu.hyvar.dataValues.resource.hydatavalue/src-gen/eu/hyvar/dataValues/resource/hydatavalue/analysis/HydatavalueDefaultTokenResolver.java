 ...
 * </p>
 */
public class HydatavalueDefaultTokenResolver implements eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueTokenResolver {
	 ...
	 */
	public HydatavalueDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public HydatavalueDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, EStructuralFeature feature, eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : eu.hyvar.dataValues.resource.hydatavalue.grammar.HydatavalueGrammarInformationProvider.INSTANCE.getKeywords()) {

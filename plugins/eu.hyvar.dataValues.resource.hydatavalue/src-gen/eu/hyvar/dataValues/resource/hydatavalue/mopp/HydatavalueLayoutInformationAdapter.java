...
/**
 * <p>
 * A HydatavalueLayoutInformationAdapter is used to store layout information that
 ...
 * HydatavalueLayoutInformationAdapters are attached to EObjects and aggregate
 ...
 * </p>
 */
public class HydatavalueLayoutInformationAdapter implements Adapter {
	 ...
	 * reference.
	 */
	private List<eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueLayoutInformation> layoutInformations = new ArrayList<eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueLayoutInformation>();
	...
	public List<eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueLayoutInformation layoutInformation) {

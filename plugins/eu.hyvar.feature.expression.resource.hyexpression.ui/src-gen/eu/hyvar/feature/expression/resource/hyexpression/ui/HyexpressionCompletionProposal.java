 ...
 */
public class HyexpressionCompletionProposal implements Comparable<HyexpressionCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionExpectedTerminal expectedTerminal;
	...
	public HyexpressionCompletionProposal(eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public HyexpressionCompletionProposal(eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public HyexpressionCompletionProposal(eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof HyexpressionCompletionProposal) {
			HyexpressionCompletionProposal other = (HyexpressionCompletionProposal) object;
	...
	public int compareTo(HyexpressionCompletionProposal object) {
		if (object instanceof HyexpressionCompletionProposal) {
			HyexpressionCompletionProposal other = (HyexpressionCompletionProposal) object;

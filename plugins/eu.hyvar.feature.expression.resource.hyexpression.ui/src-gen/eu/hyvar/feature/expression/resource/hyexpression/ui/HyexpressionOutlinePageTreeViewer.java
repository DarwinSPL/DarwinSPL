 ...
 * a specified depth.
 */
public class HyexpressionOutlinePageTreeViewer extends TreeViewer {
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionPlugin.logError("Exception while refreshing outline view", e);
		}
	}

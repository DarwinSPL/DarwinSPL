 ...
 */
public class HyexpressionHighlighting implements ISelectionProvider, ISelectionChangedListener {
	...
	private eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionEditor editor;
	private ProjectionViewer projectionViewer;
	private eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionOccurrence occurrence;
	private eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionBackgroundParsingListener {
	...
	private void addListeners(eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionEditor editor) {
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionPositionCategory.BRACKET.toString());
	}
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionEObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		isHighlightBrackets = preferenceStore.getBoolean(eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));

...
public class HyexpressionPropertySheetPage extends PropertySheetPage implements ISelectionChangedListener {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection iSelection) {
		...
		if (iSelection instanceof eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionEObjectSelection) {
			final eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionEObjectSelection selection = (eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionEObjectSelection) iSelection;

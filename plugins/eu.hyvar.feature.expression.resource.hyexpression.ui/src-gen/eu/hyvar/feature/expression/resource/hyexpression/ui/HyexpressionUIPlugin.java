 ...
 */
public class HyexpressionUIPlugin extends AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "eu.hyvar.feature.expression.resource.hyexpression.ui";
	public static final String EDITOR_ID = "eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionEditor";
	...
	private static HyexpressionUIPlugin plugin;
	
	public HyexpressionUIPlugin() {
		super();
	}
	...
	public static HyexpressionUIPlugin getDefault() {
		return plugin;
	}
	...
	protected static IStatus log(int type, String message, Throwable throwable) {
		IStatus status;
		if (throwable != null) {
			status = new Status(type, HyexpressionUIPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new Status(type, HyexpressionUIPlugin.PLUGIN_ID, message);
		}
		final HyexpressionUIPlugin pluginInstance = HyexpressionUIPlugin.getDefault();

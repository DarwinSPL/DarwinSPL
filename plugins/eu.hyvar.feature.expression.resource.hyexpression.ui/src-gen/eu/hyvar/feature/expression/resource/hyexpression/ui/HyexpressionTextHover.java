 ...
 */
public class HyexpressionTextHover implements ITextHover, ITextHoverExtension, ITextHoverExtension2 {
	...
	private eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends Action {
		...
		private final eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionDocBrowserInformationControlInput infoInput = (eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionHyperlink hyperlink = new eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	 ...
	 */
	public HyexpressionTextHover(eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
		...
		return ((eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionDocBrowserInformationControlInput internalGetHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
	 ...
	 */
	private eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionDocBrowserInformationControlInput getHoverInfo(List<EObject> elements, ITextViewer textViewer, eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionHTMLPrinter.insertPageProlog(buffer, 0, eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionTextHover.getStyleSheet());
			eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionHTMLPrinter.addPageEpilog(buffer);
			return new eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		Bundle bundle = Platform.getBundle(eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionUIPlugin.PLUGIN_ID);
		URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return eu.hyvar.feature.expression.resource.hyexpression.util.HyexpressionStreamUtil.getContent(styleSheetURL.openStream());

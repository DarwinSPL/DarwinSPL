 ...
 * </p>
 */
public class HyexpressionBracketPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionMetaInformation().getSyntaxName();
	
	private eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public HyexpressionBracketPreferencePage() {
		super();
		
		eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionMetaInformation metaInformation = new eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionMetaInformation();
	...
	public void init(IWorkbench workbench) {
		...
		bracketsTmp = new eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionBracketSet();
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void addListenersToStyleButtons() {
		...
		bracketsList.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionBracketPair bracketPair = getSelectedBracketPair();
				if (bracketPair == null) {
					removeBracketButton.setEnabled(false);
					return;
				}
	...
	protected eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionBracketPair getSelectedBracketPair() {

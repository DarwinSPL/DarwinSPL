...
public class HyexpressionOutlinePageTreeViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof EObject && o2 instanceof EObject) {
			...
			eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionNameProvider nameProvider = new eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionMetaInformation().createNameProvider();

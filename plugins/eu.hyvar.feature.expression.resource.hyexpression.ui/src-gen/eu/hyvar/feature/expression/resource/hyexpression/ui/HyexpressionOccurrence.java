 ...
 */
public class HyexpressionOccurrence {
	
	private static interface ITokenScannerConstraint {
		public boolean mustStop(eu.hyvar.feature.expression.resource.hyexpression.ui.IHyexpressionTokenScanner tokenScanner);
	}
	
	public final static String OCCURRENCE_ANNOTATION_ID = "eu.hyvar.feature.expression.resource.hyexpression.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "eu.hyvar.feature.expression.resource.hyexpression.ui.occurences.declaration";
	
	private final static eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionPositionHelper positionHelper = new eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionPositionHelper();
	 ...
	 */
	private eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionTextResource textResource;
	...
	/**
	 * <p>
	 * Creates a HyexpressionOccurrence object to find positions to highlight.
	 * </p>
	 * 
	 * @param textResource the text resource for location
	 * @param projectionViewer the viewer for the text
	 */
	public HyexpressionOccurrence(eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionTextResource textResource, ProjectionViewer projectionViewer) {
		super();
	...
	protected int getLength(eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionLocationMap locationMap, EObject eObject) {
	...
	public void updateOccurrenceAnnotations() {
		...
		eu.hyvar.feature.expression.resource.hyexpression.ui.IHyexpressionTokenScanner tokenScanner = scan(referencedElement, new ITokenScannerConstraint() {
	...
	protected List<String> addAnnotationsForDefinition(EObject referencedElement, String definitionText, int definitionOffset, final int caretOffset) {
		...
		if (definitionText == null) {
			...
			final List<String> names = new eu.hyvar.feature.expression.resource.hyexpression.analysis.HyexpressionDefaultNameProvider().getNames(referencedElement);
			scan(referencedElement, new ITokenScannerConstraint() {
				...
				public boolean mustStop(eu.hyvar.feature.expression.resource.hyexpression.ui.IHyexpressionTokenScanner tokenScanner) {
					...
					if (names.contains(text) && isContainedIn(offset, length, caretOffset)) {
						...
						addAnnotation(document, eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionPositionCategory.DEFINITION, text, offset, text.length());
					}
					return false;
				}
			});
			...
			addAnnotation(document, eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionPositionCategory.DEFINITION, definitionText, definitionOffset, definitionText.length());
	...
	protected int getIndexOf(EObject eObject, final String text) {
		eu.hyvar.feature.expression.resource.hyexpression.ui.IHyexpressionTokenScanner tokenScanner = scan(eObject, new ITokenScannerConstraint() {
	...
	protected eu.hyvar.feature.expression.resource.hyexpression.ui.IHyexpressionTokenScanner scan(EObject object, ITokenScannerConstraint constraint) {
		IDocument document = getSourceViewer().getDocument();
		
		eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionLocationMap locationMap = textResource.getLocationMap();
		
		eu.hyvar.feature.expression.resource.hyexpression.ui.IHyexpressionTokenScanner tokenScanner = createTokenScanner();
	...
	protected eu.hyvar.feature.expression.resource.hyexpression.ui.IHyexpressionTokenScanner createTokenScanner() {
		return new eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionUIMetaInformation().createTokenScanner(null, null);
	}
	...
	protected void removeAnnotations() {
		removeAnnotations(eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionOccurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionOccurrence.DECLARATION_ANNOTATION_ID);
	}

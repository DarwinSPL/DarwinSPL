...
/**
 * The HyexpressionAutoEditStrategy extends the default auto edit strategy such
 ...
 */
public class HyexpressionAutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	
	private eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionBracketSet bracketSet;
	
	public HyexpressionAutoEditStrategy() {
		super();
		...
		if (plugin != null) {
			...
			bracketSet = new eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionBracketSet();
	 ...
	 */
	@Deprecated
	public void setBracketSet(eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionBracketSet bracketSet) {

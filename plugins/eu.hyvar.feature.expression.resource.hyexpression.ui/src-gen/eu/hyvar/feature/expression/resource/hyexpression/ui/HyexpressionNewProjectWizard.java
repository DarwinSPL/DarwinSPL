 ...
 * </p>
 */
public class HyexpressionNewProjectWizard extends Wizard implements INewWizard, IExecutableExtension {
	
	/**
	 * The name of the ZIP file that is used as content for the new project (relative
	 * to the root of the resource UI plug-in).
	 */
	public final static String NEW_PROJECT_ZIP_FILE_NAME = eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionUIResourceBundle.NEW_PROJECT_ZIP_FILE_NAME;
	 ...
	 */
	protected String pageName = eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_NAME;
	 ...
	 */
	protected String pageDescription = eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_DESCRIPTION;
	
	/**
	 * The name of the project in the project creation page
	 */
	protected String pageProjectName = eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionUIResourceBundle.NEW_PROJECT_WIZARD_PROJECT_NAME;
	 ...
	 * eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionNewProjectWizar
	 * dLogic.
	 */
	...
	protected void doPerformFinish(IProgressMonitor monitor) throws Exception {
		new eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionNewProjectWizardLogic().createExampleProject(monitor, wizardNewProjectCreationPage.getLocationPath(), wizardNewProjectCreationPage.getProjectName(), eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionUIPlugin.PLUGIN_ID, NEW_PROJECT_ZIP_FILE_NAME);
	}

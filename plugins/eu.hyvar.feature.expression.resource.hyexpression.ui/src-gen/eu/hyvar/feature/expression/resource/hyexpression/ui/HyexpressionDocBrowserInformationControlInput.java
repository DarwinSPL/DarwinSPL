 ...
 * olInput</code>.
 */
public class HyexpressionDocBrowserInformationControlInput {
	
	private final HyexpressionDocBrowserInformationControlInput fPrevious;
	private HyexpressionDocBrowserInformationControlInput fNext;
	 ...
	 */
	public HyexpressionDocBrowserInformationControlInput(HyexpressionDocBrowserInformationControlInput previous, EObject element, Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public HyexpressionDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public HyexpressionDocBrowserInformationControlInput getNext() {
		return fNext;
	}

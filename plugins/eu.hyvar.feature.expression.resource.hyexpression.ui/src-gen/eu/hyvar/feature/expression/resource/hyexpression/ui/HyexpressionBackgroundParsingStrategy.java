 ...
 */
public class HyexpressionBackgroundParsingStrategy {
	 ...
	 */
	public void parse(DocumentEvent event, final eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionTextResource resource, final eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(IDocument document, final eu.hyvar.feature.expression.resource.hyexpression.IHyexpressionTextResource resource, final eu.hyvar.feature.expression.resource.hyexpression.ui.HyexpressionEditor editor, long delay) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionResource) {
							eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionResource concreteResource = (eu.hyvar.feature.expression.resource.hyexpression.mopp.HyexpressionResource) resource;

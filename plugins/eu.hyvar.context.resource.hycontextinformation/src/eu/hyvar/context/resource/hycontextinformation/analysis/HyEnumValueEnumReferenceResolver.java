...
public class HyEnumValueEnumReferenceResolver implements eu.hyvar.context.resource.hycontextinformation.IHycontextinformationReferenceResolver<eu.hyvar.dataValues.HyEnumValue, eu.hyvar.dataValues.HyEnum> {
	...
	public void resolve(String identifier, eu.hyvar.dataValues.HyEnumValue container, EReference reference, int position, boolean resolveFuzzy, final eu.hyvar.context.resource.hycontextinformation.IHycontextinformationReferenceResolveResult<eu.hyvar.dataValues.HyEnum> result) {

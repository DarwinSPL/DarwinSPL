...
public class HyEnumValueEnumLiteralReferenceResolver implements eu.hyvar.context.resource.hycontextinformation.IHycontextinformationReferenceResolver<eu.hyvar.dataValues.HyEnumValue, eu.hyvar.dataValues.HyEnumLiteral> {
	...
	public void resolve(String identifier, eu.hyvar.dataValues.HyEnumValue container, EReference reference, int position, boolean resolveFuzzy, final eu.hyvar.context.resource.hycontextinformation.IHycontextinformationReferenceResolveResult<eu.hyvar.dataValues.HyEnumLiteral> result) {
		delegate.resolve(identifier, container, reference, position, resolveFuzzy, new eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueReferenceResolveResult<eu.hyvar.dataValues.HyEnumLiteral>() {
			...
			public void addQuickFix(final eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueQuickFix quickFix) {
				result.addQuickFix(new eu.hyvar.context.resource.hycontextinformation.IHycontextinformationQuickFix() {

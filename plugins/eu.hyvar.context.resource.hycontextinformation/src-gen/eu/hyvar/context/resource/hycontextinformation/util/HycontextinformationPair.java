 ...
 */
public class HycontextinformationPair<T1, T2> {
	
	private T1 left;
	private T2 right;
	
	public HycontextinformationPair(T1 left, T2 right) {
		this.left = left;
		this.right = right;
	}
	...
	public boolean equals(Object obj) {
		...
		HycontextinformationPair<?,?> other = (HycontextinformationPair<?,?>) obj;
		if (left == null) {
			if (other.left != null) {
				return false;
			}

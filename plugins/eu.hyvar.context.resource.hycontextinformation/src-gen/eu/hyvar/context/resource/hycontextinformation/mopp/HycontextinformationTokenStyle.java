...
public class HycontextinformationTokenStyle implements eu.hyvar.context.resource.hycontextinformation.IHycontextinformationTokenStyle {
	...
	public HycontextinformationTokenStyle(int[] colorAsRGB, int[] backgroundColorAsRGB, boolean bold, boolean italic, boolean striketrough, boolean underline) {
		super();
	...
	public HycontextinformationTokenStyle(eu.hyvar.context.resource.hycontextinformation.IHycontextinformationTokenStyle styleToCopy) {
	...
	public boolean equals(Object obj) {
		...
		eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationTokenStyle other = (eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationTokenStyle) obj;

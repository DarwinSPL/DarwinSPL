...
public class HycontextinformationNature implements IProjectNature {
	
	public static final String NATURE_ID = "eu.hyvar.context.resource.hycontextinformation.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}

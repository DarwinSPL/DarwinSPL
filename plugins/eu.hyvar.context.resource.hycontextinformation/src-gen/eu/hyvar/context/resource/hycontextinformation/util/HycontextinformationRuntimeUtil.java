 ...
 */
public class HycontextinformationRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {

...
public abstract class HycontextinformationANTLRParserBase extends Parser implements eu.hyvar.context.resource.hycontextinformation.IHycontextinformationTextParser {
	 ...
	 * result object.
	 */
	protected Collection<eu.hyvar.context.resource.hycontextinformation.IHycontextinformationCommand<eu.hyvar.context.resource.hycontextinformation.IHycontextinformationTextResource>> postParseCommands;
	 ...
	 */
	private eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationTokenResolveResult tokenResolveResult = new eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationTokenResolveResult();
	...
	public HycontextinformationANTLRParserBase(TokenStream input) {
		super(input);
	}
	
	public HycontextinformationANTLRParserBase(TokenStream input, RecognizerSharedState state) {
		super(input, state);
	}
	
	protected void retrieveLayoutInformation(EObject element, eu.hyvar.context.resource.hycontextinformation.grammar.HycontextinformationSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		isElementToStore |= syntaxElement instanceof eu.hyvar.context.resource.hycontextinformation.grammar.HycontextinformationPlaceholder;
		isElementToStore |= syntaxElement instanceof eu.hyvar.context.resource.hycontextinformation.grammar.HycontextinformationKeyword;
		isElementToStore |= syntaxElement instanceof eu.hyvar.context.resource.hycontextinformation.grammar.HycontextinformationEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof eu.hyvar.context.resource.hycontextinformation.grammar.HycontextinformationBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
		...
		layoutInformationAdapter.addLayoutInformation(new eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationLayoutInformation(syntaxElement, object, offset, hiddenTokenText.toString(), visibleTokenText.toString()));
	...
	protected <ContainerType extends EObject, ReferenceType extends EObject> void registerContextDependentProxy(final eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationContextDependentURIFragmentFactory<ContainerType, ReferenceType> factory, final ContainerType container, final EReference reference, final String id, final EObject proxy) {
		final int position;
		if (reference.isMany()) {
	...
	protected void addMapEntry(EObject element, EStructuralFeature structuralFeature, eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationDummyEObject dummy) {
		Object value = element.eGet(structuralFeature);
		Object mapKey = dummy.getValueByName("key");
		Object mapValue = dummy.getValueByName("value");
		if (value instanceof EMap<?, ?>) {
			EMap<Object, Object> valueMap = eu.hyvar.context.resource.hycontextinformation.util.HycontextinformationMapUtil.castToEMap(value);
	...
	protected EObject apply(EObject target, List<EObject> dummyEObjects) {
		...
		for (EObject object : dummyEObjects) {
			assert(object instanceof eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationDummyEObject);
			eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationDummyEObject dummy = (eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationDummyEObject) object;
	...
	protected eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationTokenResolveResult getFreshTokenResolveResult() {
	...
	protected eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationReferenceResolverSwitch getReferenceResolverSwitch() {
		eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationReferenceResolverSwitch resolverSwitch = (eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationReferenceResolverSwitch) metaInformation.getReferenceResolverSwitch();
	...
	public boolean isLayoutInformationRecordingEnabled() {
		...
		Object value = options.get(eu.hyvar.context.resource.hycontextinformation.IHycontextinformationOptions.DISABLE_LAYOUT_INFORMATION_RECORDING);
	...
	public boolean isLocationMapEnabled() {
		...
		Object value = options.get(eu.hyvar.context.resource.hycontextinformation.IHycontextinformationOptions.DISABLE_LOCATION_MAP);
		return value == null || Boolean.FALSE.equals(value);
	}

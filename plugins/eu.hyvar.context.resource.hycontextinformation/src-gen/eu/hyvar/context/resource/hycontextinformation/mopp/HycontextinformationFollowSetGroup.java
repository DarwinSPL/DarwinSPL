 ...
 */
public class HycontextinformationFollowSetGroup {
	
	private List<eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationExpectedTerminal> expectedTerminals = new ArrayList<eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationExpectedTerminal>();
	
	public void add(eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationExpectedTerminal expectedTerminal) {
		expectedTerminals.add(expectedTerminal);
	}
	
	public List<eu.hyvar.context.resource.hycontextinformation.mopp.HycontextinformationExpectedTerminal> getExpectedTerminals() {
	...
	public String toString() {
		return "HycontextinformationFollowSetGroup" + expectedTerminals;
	}

...
public class HycontextinformationMapUtil {
	...
	public static <K> void putAndMergeKeys(Map<K, Object> map, K key, Object value) {
		...
		if (map.containsKey(key)) {
			...
			if (currentValue instanceof List<?>) {
				...
				List<Object> currentValueAsObjectList = eu.hyvar.context.resource.hycontextinformation.util.HycontextinformationListUtil.copySafelyToObjectList(currentValueAsList);

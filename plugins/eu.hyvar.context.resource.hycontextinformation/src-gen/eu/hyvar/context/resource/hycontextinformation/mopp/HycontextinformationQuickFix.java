...
public abstract class HycontextinformationQuickFix implements eu.hyvar.context.resource.hycontextinformation.IHycontextinformationQuickFix {
	...
	public HycontextinformationQuickFix(String displayString, String imageKey, EObject contextObject) {
		this(displayString, imageKey, Collections.singleton(contextObject), contextObject.eResource());
	}
	
	public HycontextinformationQuickFix(String displayString, String imageKey, Collection<EObject> contextObjects) {
		this(displayString, imageKey, contextObjects, contextObjects.iterator().next().eResource());
	}
	
	public HycontextinformationQuickFix(String displayString, String imageKey, Collection<EObject> contextObjects, Resource resource) {
		super();
	...
	public String apply(String currentText) {
		...
		try {
			...
			new eu.hyvar.context.resource.hycontextinformation.util.HycontextinformationRuntimeUtil().logError("Exception while applying quick fix", e);
		}
		return null;
	}

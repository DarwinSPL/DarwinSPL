...
public class HycontextinformationCopiedEObjectInternalEList extends eu.hyvar.context.resource.hycontextinformation.util.HycontextinformationCopiedEList<EObject> implements InternalEList<EObject> {
	
	private InternalEList<EObject> original;
	private InternalEList<EObject> copy;
	
	public HycontextinformationCopiedEObjectInternalEList(InternalEList<EObject> original) {
		super(original);

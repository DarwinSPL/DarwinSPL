 ...
 * instance of HycontextinformationDefaultTokenResolver which performs a standard
 * conversion based on the EMF type conversion. This includes conversion of
 * registered EDataTypes.
 * </p>
 * 
 * @see
 * eu.hyvar.context.resource.hycontextinformation.analysis.HycontextinformationDefa
 * ultTokenResolver
 */
public interface IHycontextinformationTokenResolver extends eu.hyvar.context.resource.hycontextinformation.IHycontextinformationConfigurable {

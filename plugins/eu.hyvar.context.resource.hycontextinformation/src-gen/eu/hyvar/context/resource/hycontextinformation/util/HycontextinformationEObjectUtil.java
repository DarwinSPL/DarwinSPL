 ...
 */
public class HycontextinformationEObjectUtil {
	...
	public static Object invokeOperation(EObject element, EOperation o) {
		...
		try {
			...
			new eu.hyvar.context.resource.hycontextinformation.util.HycontextinformationRuntimeUtil().logError("Exception while matching proxy URI.", e);

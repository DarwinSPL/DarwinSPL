 ...
 */
public class HycontextinformationBracketPair implements eu.hyvar.context.resource.hycontextinformation.IHycontextinformationBracketPair {
	...
	public HycontextinformationBracketPair(String openingBracket, String closingBracket, boolean closingEnabledInside, boolean closeAfterEnter) {
		super();
		this.openingBracket = openingBracket;
		this.closingBracket = closingBracket;
		this.closingEnabledInside = closingEnabledInside;

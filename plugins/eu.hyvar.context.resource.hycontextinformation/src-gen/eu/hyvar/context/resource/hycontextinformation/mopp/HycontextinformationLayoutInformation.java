...
/**
 * <p>
 * HycontextinformationLayoutInformation objects are used to store layout
 ...
 * </p>
 * <p>
 * HycontextinformationLayoutInformations are aggregated in
 * LayoutInformationAdapters. One HycontextinformationLayoutInformation contains
 * the layout that was found before a keyword, attribute or reference.
 * </p>
 */
public class HycontextinformationLayoutInformation {
	 ...
	 */
	private final eu.hyvar.context.resource.hycontextinformation.grammar.HycontextinformationSyntaxElement syntaxElement;
	...
	public HycontextinformationLayoutInformation(eu.hyvar.context.resource.hycontextinformation.grammar.HycontextinformationSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public eu.hyvar.context.resource.hycontextinformation.grammar.HycontextinformationSyntaxElement getSyntaxElement() {

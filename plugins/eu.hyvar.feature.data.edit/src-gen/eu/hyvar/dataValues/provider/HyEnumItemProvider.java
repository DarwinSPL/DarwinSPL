...
/**
 * This is the item provider adapter for a {@link eu.hyvar.dataValues.HyEnum} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HyEnumItemProvider 
	 ...
	 * @generated
	 */
	public HyEnumItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HyEnum_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HyEnum_name_feature", "_UI_HyEnum_type"),
				 HyDataValuesPackage.Literals.HY_ENUM__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HyDataValuesPackage.Literals.HY_ENUM__LITERALS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HyEnum"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HyEnum.class)) {
			case HyDataValuesPackage.HY_ENUM__VALID_SINCE:
			case HyDataValuesPackage.HY_ENUM__VALID_UNTIL:
			case HyDataValuesPackage.HY_ENUM__ID:
			case HyDataValuesPackage.HY_ENUM__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case HyDataValuesPackage.HY_ENUM__LITERALS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HyDataValuesPackage.Literals.HY_ENUM__LITERALS,
				 HyDataValuesFactory.eINSTANCE.createHyEnumLiteral()));
	}

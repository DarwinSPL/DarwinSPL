...
public abstract class DwFeatureModelEvolutionImporter<T> {
	...
	public abstract HyFeatureModel importFeatureModelFromPaths(Map<String, Date> pathsToFiles);

	public abstract HyFeatureModel importFeatureModelFromIFiles(Map<IFile, Date> featureModelFiles);

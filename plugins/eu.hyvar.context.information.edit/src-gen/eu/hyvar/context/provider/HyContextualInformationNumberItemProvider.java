...
/**
 * This is the item provider adapter for a {@link eu.hyvar.context.HyContextualInformationNumber} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HyContextualInformationNumberItemProvider 
	 ...
	 * @generated
	 */
	public HyContextualInformationNumberItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addMinPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HyContextualInformationNumber_min_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HyContextualInformationNumber_min_feature", "_UI_HyContextualInformationNumber_type"),
				 HyContextInformationPackage.Literals.HY_CONTEXTUAL_INFORMATION_NUMBER__MIN,
				 true,
				 false,
				 false,
	...
	protected void addMaxPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HyContextualInformationNumber_max_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HyContextualInformationNumber_max_feature", "_UI_HyContextualInformationNumber_type"),
				 HyContextInformationPackage.Literals.HY_CONTEXTUAL_INFORMATION_NUMBER__MAX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	/**
	 * This returns HyContextualInformationNumber.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HyContextualInformationNumber"));
	}
...
//		String label = ((HyContextualInformationNumber)object).getName();
...
//			getString("_UI_HyContextualInformationNumber_type") + " " + label;
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HyContextualInformationNumber.class)) {
			case HyContextInformationPackage.HY_CONTEXTUAL_INFORMATION_NUMBER__VALID_SINCE:

 ...
 */
public class DwprofileBracketPair implements de.darwinspl.preferences.resource.dwprofile.IDwprofileBracketPair {
	...
	public DwprofileBracketPair(String openingBracket, String closingBracket, boolean closingEnabledInside, boolean closeAfterEnter) {
		super();
		this.openingBracket = openingBracket;
		this.closingBracket = closingBracket;
		this.closingEnabledInside = closingEnabledInside;

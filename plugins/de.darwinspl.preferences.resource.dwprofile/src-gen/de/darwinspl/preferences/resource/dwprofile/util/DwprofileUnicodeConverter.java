 ...
 * to 4 bytes).
 */
public class DwprofileUnicodeConverter extends de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileInputStreamProcessor {
	 ...
	 */
	public DwprofileUnicodeConverter(InputStream inputStream) {

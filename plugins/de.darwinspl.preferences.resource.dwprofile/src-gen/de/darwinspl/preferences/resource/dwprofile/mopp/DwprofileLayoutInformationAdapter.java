...
/**
 * <p>
 * A DwprofileLayoutInformationAdapter is used to store layout information that is
 ...
 * DwprofileLayoutInformationAdapters are attached to EObjects and aggregate
 ...
 * </p>
 */
public class DwprofileLayoutInformationAdapter implements Adapter {
	 ...
	 * reference.
	 */
	private List<de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileLayoutInformation> layoutInformations = new ArrayList<de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileLayoutInformation>();
	...
	public List<de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileLayoutInformation layoutInformation) {

...
public class DwprofileTokenStyle implements de.darwinspl.preferences.resource.dwprofile.IDwprofileTokenStyle {
	...
	public DwprofileTokenStyle(int[] colorAsRGB, int[] backgroundColorAsRGB, boolean bold, boolean italic, boolean striketrough, boolean underline) {
		super();
	...
	public DwprofileTokenStyle(de.darwinspl.preferences.resource.dwprofile.IDwprofileTokenStyle styleToCopy) {
	...
	public boolean equals(Object obj) {
		...
		de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileTokenStyle other = (de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileTokenStyle) obj;

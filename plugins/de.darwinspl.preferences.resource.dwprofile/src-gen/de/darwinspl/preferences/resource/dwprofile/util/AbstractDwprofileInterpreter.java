 ...
 */
public class AbstractDwprofileInterpreter<ResultType, ContextType> {
	
	private Stack<EObject> interpretationStack = new Stack<EObject>();
	private List<de.darwinspl.preferences.resource.dwprofile.IDwprofileInterpreterListener> listeners = new ArrayList<de.darwinspl.preferences.resource.dwprofile.IDwprofileInterpreterListener>();
	...
	public ResultType interprete(EObject object, ContextType context) {
		ResultType result = null;
		if (object instanceof de.darwinspl.preferences.DwProfile) {
			result = interprete_de_darwinspl_preferences_DwProfile((de.darwinspl.preferences.DwProfile) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof de.darwinspl.preferences.DwPreference) {
			result = interprete_de_darwinspl_preferences_DwPreference((de.darwinspl.preferences.DwPreference) object, context);
		}
		if (result != null) {
			return result;
		}
	...
	public ResultType interprete_de_darwinspl_preferences_DwProfile(DwProfile dwProfile, ContextType context) {
		return null;
	}
	
	public ResultType interprete_de_darwinspl_preferences_DwPreference(DwPreference dwPreference, ContextType context) {
		return null;
	}
	...
	private void notifyListeners(EObject element) {
		for (de.darwinspl.preferences.resource.dwprofile.IDwprofileInterpreterListener listener : listeners) {
	...
	public void addListener(de.darwinspl.preferences.resource.dwprofile.IDwprofileInterpreterListener newListener) {
		listeners.add(newListener);
	}
	
	public boolean removeListener(de.darwinspl.preferences.resource.dwprofile.IDwprofileInterpreterListener listener) {

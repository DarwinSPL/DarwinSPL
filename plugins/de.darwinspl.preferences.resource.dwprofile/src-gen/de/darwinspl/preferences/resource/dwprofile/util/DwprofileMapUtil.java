	...
	public static <K> void putAndMergeKeys(Map<K, Object> map, K key, Object value) {
		...
		if (map.containsKey(key)) {
			...
			if (currentValue instanceof List<?>) {
				...
				List<Object> currentValueAsObjectList = de.darwinspl.preferences.resource.dwprofile.util.DwprofileListUtil.copySafelyToObjectList(currentValueAsList);

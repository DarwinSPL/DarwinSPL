...
public class DwprofileNature implements IProjectNature {
	
	public static final String NATURE_ID = "de.darwinspl.preferences.resource.dwprofile.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}

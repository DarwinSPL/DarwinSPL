...
public abstract class DwprofileANTLRParserBase extends Parser implements de.darwinspl.preferences.resource.dwprofile.IDwprofileTextParser {
	 ...
	 * result object.
	 */
	protected Collection<de.darwinspl.preferences.resource.dwprofile.IDwprofileCommand<de.darwinspl.preferences.resource.dwprofile.IDwprofileTextResource>> postParseCommands;
	 ...
	 */
	private de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileTokenResolveResult tokenResolveResult = new de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileTokenResolveResult();
	...
	public DwprofileANTLRParserBase(TokenStream input) {
		super(input);
	}
	
	public DwprofileANTLRParserBase(TokenStream input, RecognizerSharedState state) {
		super(input, state);
	}
	
	protected void retrieveLayoutInformation(EObject element, de.darwinspl.preferences.resource.dwprofile.grammar.DwprofileSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		isElementToStore |= syntaxElement instanceof de.darwinspl.preferences.resource.dwprofile.grammar.DwprofilePlaceholder;
		isElementToStore |= syntaxElement instanceof de.darwinspl.preferences.resource.dwprofile.grammar.DwprofileKeyword;
		isElementToStore |= syntaxElement instanceof de.darwinspl.preferences.resource.dwprofile.grammar.DwprofileEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof de.darwinspl.preferences.resource.dwprofile.grammar.DwprofileBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
		...
		layoutInformationAdapter.addLayoutInformation(new de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileLayoutInformation(syntaxElement, object, offset, hiddenTokenText.toString(), visibleTokenText.toString()));
	...
	protected void addMapEntry(EObject element, EStructuralFeature structuralFeature, de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileDummyEObject dummy) {
		Object value = element.eGet(structuralFeature);
		Object mapKey = dummy.getValueByName("key");
		Object mapValue = dummy.getValueByName("value");
		if (value instanceof EMap<?, ?>) {
			EMap<Object, Object> valueMap = de.darwinspl.preferences.resource.dwprofile.util.DwprofileMapUtil.castToEMap(value);
	...
	protected EObject apply(EObject target, List<EObject> dummyEObjects) {
		...
		for (EObject object : dummyEObjects) {
			assert(object instanceof de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileDummyEObject);
			de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileDummyEObject dummy = (de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileDummyEObject) object;
	...
	protected de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileTokenResolveResult getFreshTokenResolveResult() {
	...
	protected de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileReferenceResolverSwitch getReferenceResolverSwitch() {
		de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileReferenceResolverSwitch resolverSwitch = (de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileReferenceResolverSwitch) metaInformation.getReferenceResolverSwitch();
	...
	public boolean isLayoutInformationRecordingEnabled() {
		...
		Object value = options.get(de.darwinspl.preferences.resource.dwprofile.IDwprofileOptions.DISABLE_LAYOUT_INFORMATION_RECORDING);
	...
	public boolean isLocationMapEnabled() {
		...
		Object value = options.get(de.darwinspl.preferences.resource.dwprofile.IDwprofileOptions.DISABLE_LOCATION_MAP);
		return value == null || Boolean.FALSE.equals(value);
	}

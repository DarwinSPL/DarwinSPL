 ...
 */
public class DwprofileEObjectUtil {
	...
	public static Object invokeOperation(EObject element, EOperation o) {
		...
		try {
			...
			new de.darwinspl.preferences.resource.dwprofile.util.DwprofileRuntimeUtil().logError("Exception while matching proxy URI.", e);

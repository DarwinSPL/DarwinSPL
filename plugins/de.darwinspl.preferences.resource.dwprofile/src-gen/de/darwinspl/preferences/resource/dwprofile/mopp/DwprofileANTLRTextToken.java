...
public class DwprofileANTLRTextToken extends de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileTextToken {
	
	private final static de.darwinspl.preferences.resource.dwprofile.IDwprofileMetaInformation metaInformation = new de.darwinspl.preferences.resource.dwprofile.mopp.DwprofileMetaInformation();
	
	public DwprofileANTLRTextToken(Token antlrToken) {

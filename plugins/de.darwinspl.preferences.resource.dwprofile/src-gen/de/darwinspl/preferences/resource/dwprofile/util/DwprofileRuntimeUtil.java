 ...
 */
public class DwprofileRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			de.darwinspl.preferences.resource.dwprofile.mopp.DwprofilePlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			de.darwinspl.preferences.resource.dwprofile.mopp.DwprofilePlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {

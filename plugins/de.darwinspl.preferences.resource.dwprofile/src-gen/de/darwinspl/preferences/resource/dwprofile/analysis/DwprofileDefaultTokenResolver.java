 ...
 * </p>
 */
public class DwprofileDefaultTokenResolver implements de.darwinspl.preferences.resource.dwprofile.IDwprofileTokenResolver {
	 ...
	 */
	public DwprofileDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public DwprofileDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, EStructuralFeature feature, de.darwinspl.preferences.resource.dwprofile.IDwprofileTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : de.darwinspl.preferences.resource.dwprofile.grammar.DwprofileGrammarInformationProvider.INSTANCE.getKeywords()) {

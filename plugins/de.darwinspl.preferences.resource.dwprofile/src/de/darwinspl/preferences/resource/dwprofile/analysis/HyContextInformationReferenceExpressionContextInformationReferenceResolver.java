...
public class HyContextInformationReferenceExpressionContextInformationReferenceResolver implements de.darwinspl.preferences.resource.dwprofile.IDwprofileReferenceResolver<eu.hyvar.feature.expression.HyContextInformationReferenceExpression, eu.hyvar.context.HyContextualInformation> {
	...
	public void resolve(String identifier, eu.hyvar.feature.expression.HyContextInformationReferenceExpression container, EReference reference, int position, boolean resolveFuzzy, final de.darwinspl.preferences.resource.dwprofile.IDwprofileReferenceResolveResult<eu.hyvar.context.HyContextualInformation> result) {

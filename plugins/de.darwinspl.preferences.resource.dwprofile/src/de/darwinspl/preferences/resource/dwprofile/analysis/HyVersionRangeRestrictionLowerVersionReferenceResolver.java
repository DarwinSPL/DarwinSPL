...
public class HyVersionRangeRestrictionLowerVersionReferenceResolver implements de.darwinspl.preferences.resource.dwprofile.IDwprofileReferenceResolver<eu.hyvar.feature.expression.HyVersionRangeRestriction, eu.hyvar.feature.HyVersion> {
	...
	public void resolve(String identifier, eu.hyvar.feature.expression.HyVersionRangeRestriction container, EReference reference, int position, boolean resolveFuzzy, final de.darwinspl.preferences.resource.dwprofile.IDwprofileReferenceResolveResult<eu.hyvar.feature.HyVersion> result) {

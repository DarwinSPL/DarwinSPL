 ...
 * olInput</code>.
 */
public class HymappingDocBrowserInformationControlInput {
	
	private final HymappingDocBrowserInformationControlInput fPrevious;
	private HymappingDocBrowserInformationControlInput fNext;
	 ...
	 */
	public HymappingDocBrowserInformationControlInput(HymappingDocBrowserInformationControlInput previous, EObject element, Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public HymappingDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public HymappingDocBrowserInformationControlInput getNext() {
		return fNext;
	}

 ...
 * </p>
 */
public class HymappingBracketPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingMetaInformation().getSyntaxName();
	
	private eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public HymappingBracketPreferencePage() {
		super();
		
		eu.hyvar.feature.mapping.resource.hymapping.IHymappingMetaInformation metaInformation = new eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingMetaInformation();
	...
	public void init(IWorkbench workbench) {
		...
		bracketsTmp = new eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingBracketSet();
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void addListenersToStyleButtons() {
		...
		bracketsList.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				eu.hyvar.feature.mapping.resource.hymapping.IHymappingBracketPair bracketPair = getSelectedBracketPair();
				if (bracketPair == null) {
					removeBracketButton.setEnabled(false);
					return;
				}
	...
	protected void performDefaults() {
		...
		enableCheckbox.setSelection(preferenceStore.getDefaultBoolean(eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		matchingBracketsColorEditor.setColorValue(PreferenceConverter.getDefaultColor(preferenceStore, BRACKETS_COLOR));
		String defaultBrackets = preferenceStore.getDefaultString(language + eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	protected eu.hyvar.feature.mapping.resource.hymapping.IHymappingBracketPair getSelectedBracketPair() {

 ...
 */
public class HymappingCompletionProposal implements Comparable<HymappingCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingExpectedTerminal expectedTerminal;
	...
	public HymappingCompletionProposal(eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public HymappingCompletionProposal(eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public HymappingCompletionProposal(eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof HymappingCompletionProposal) {
			HymappingCompletionProposal other = (HymappingCompletionProposal) object;
	...
	public int compareTo(HymappingCompletionProposal object) {
		if (object instanceof HymappingCompletionProposal) {
			HymappingCompletionProposal other = (HymappingCompletionProposal) object;

 ...
 */
public class HymappingBracketSet {
	...
	private ArrayList<eu.hyvar.feature.mapping.resource.hymapping.IHymappingBracketPair> bracketPairs;
	private String languageID;
	
	/**
	 * Creates a new bracket set to manage bracket pairs.
	 */
	public HymappingBracketSet() {
		super();
		this.languageID = new eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingMetaInformation().getSyntaxName();
		this.bracketPairs = new ArrayList<eu.hyvar.feature.mapping.resource.hymapping.IHymappingBracketPair>();
	}
	...
	public eu.hyvar.feature.mapping.resource.hymapping.IHymappingBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public eu.hyvar.feature.mapping.resource.hymapping.IHymappingBracketPair getBracketPair(String opening, String closing) {
		for (eu.hyvar.feature.mapping.resource.hymapping.IHymappingBracketPair bracketPair : bracketPairs) {
	...
	public boolean addBracketPair(String opening, String closing, boolean closingEnabledInside, boolean closeAfterEnter) {
		...
		bracketPairs.add(new eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingBracketPair(opening, closing, closingEnabledInside, closeAfterEnter));
		return true;
	}
	...
	public boolean resetBrackets(IPreferenceStore preferenceStore) {
		String bracketPairs = preferenceStore.getString(languageID + eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public eu.hyvar.feature.mapping.resource.hymapping.IHymappingBracketPair remove(String opening, String closing) {
		for (eu.hyvar.feature.mapping.resource.hymapping.IHymappingBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public void deserialize(String bracketSet) {
		bracketPairs = new ArrayList<eu.hyvar.feature.mapping.resource.hymapping.IHymappingBracketPair>();
	...
	public void highlightBrackets(IDocument document, int position, int caretOffset) {
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}

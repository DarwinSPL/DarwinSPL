...
public class HymappingOutlinePageTreeViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof EObject && o2 instanceof EObject) {
			...
			eu.hyvar.feature.mapping.resource.hymapping.IHymappingNameProvider nameProvider = new eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingMetaInformation().createNameProvider();

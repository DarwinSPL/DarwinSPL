 ...
 * @since 3.2
 */
public class HymappingBrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	...
	private eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingDocBrowserInformationControlInput fInput;
	 ...
	 */
	public HymappingBrowserInformationControl(Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public HymappingBrowserInformationControl(Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public HymappingBrowserInformationControl(Shell parent, String symbolicFontName, ToolBarManager toolBarManager) {
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingHTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}
	 ...
	 */
	public eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingDocBrowserInformationControlInput getInput() {
		return fInput;
	}

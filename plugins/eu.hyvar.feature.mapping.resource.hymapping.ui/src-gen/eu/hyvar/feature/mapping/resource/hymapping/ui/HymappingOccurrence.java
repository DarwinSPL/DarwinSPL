 ...
 */
public class HymappingOccurrence {
	
	private static interface ITokenScannerConstraint {
		public boolean mustStop(eu.hyvar.feature.mapping.resource.hymapping.ui.IHymappingTokenScanner tokenScanner);
	}
	
	public final static String OCCURRENCE_ANNOTATION_ID = "eu.hyvar.feature.mapping.resource.hymapping.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "eu.hyvar.feature.mapping.resource.hymapping.ui.occurences.declaration";
	
	private final static eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingPositionHelper positionHelper = new eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingPositionHelper();
	 ...
	 */
	private eu.hyvar.feature.mapping.resource.hymapping.IHymappingTextResource textResource;
	...
	/**
	 * <p>
	 * Creates a HymappingOccurrence object to find positions to highlight.
	 * </p>
	 * 
	 * @param textResource the text resource for location
	 * @param projectionViewer the viewer for the text
	 */
	public HymappingOccurrence(eu.hyvar.feature.mapping.resource.hymapping.IHymappingTextResource textResource, ProjectionViewer projectionViewer) {
		super();
	...
	protected int getLength(eu.hyvar.feature.mapping.resource.hymapping.IHymappingLocationMap locationMap, EObject eObject) {
	...
	public void updateOccurrenceAnnotations() {
		...
		eu.hyvar.feature.mapping.resource.hymapping.ui.IHymappingTokenScanner tokenScanner = scan(referencedElement, new ITokenScannerConstraint() {
	...
	protected List<String> addAnnotationsForDefinition(EObject referencedElement, String definitionText, int definitionOffset, final int caretOffset) {
		...
		if (definitionText == null) {
			...
			final List<String> names = new eu.hyvar.feature.mapping.resource.hymapping.analysis.HymappingDefaultNameProvider().getNames(referencedElement);
			scan(referencedElement, new ITokenScannerConstraint() {
				...
				public boolean mustStop(eu.hyvar.feature.mapping.resource.hymapping.ui.IHymappingTokenScanner tokenScanner) {
					...
					if (names.contains(text) && isContainedIn(offset, length, caretOffset)) {
						...
						addAnnotation(document, eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingPositionCategory.DEFINITION, text, offset, text.length());
					}
					return false;
				}
			});
			...
			addAnnotation(document, eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingPositionCategory.DEFINITION, definitionText, definitionOffset, definitionText.length());
	...
	protected int getIndexOf(EObject eObject, final String text) {
		eu.hyvar.feature.mapping.resource.hymapping.ui.IHymappingTokenScanner tokenScanner = scan(eObject, new ITokenScannerConstraint() {
	...
	protected eu.hyvar.feature.mapping.resource.hymapping.ui.IHymappingTokenScanner scan(EObject object, ITokenScannerConstraint constraint) {
		IDocument document = getSourceViewer().getDocument();
		
		eu.hyvar.feature.mapping.resource.hymapping.IHymappingLocationMap locationMap = textResource.getLocationMap();
		
		eu.hyvar.feature.mapping.resource.hymapping.ui.IHymappingTokenScanner tokenScanner = createTokenScanner();
	...
	protected eu.hyvar.feature.mapping.resource.hymapping.ui.IHymappingTokenScanner createTokenScanner() {
		return new eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingUIMetaInformation().createTokenScanner(null, null);
	}
	...
	protected void removeAnnotations() {
		removeAnnotations(eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingOccurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingOccurrence.DECLARATION_ANNOTATION_ID);
	}

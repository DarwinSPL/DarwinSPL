 ...
 */
public class HymappingHighlighting implements ISelectionProvider, ISelectionChangedListener {
	...
	private eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingEditor editor;
	private ProjectionViewer projectionViewer;
	private eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingOccurrence occurrence;
	private eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, eu.hyvar.feature.mapping.resource.hymapping.IHymappingBackgroundParsingListener {
	...
	private void addListeners(eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingEditor editor) {
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingPositionCategory.BRACKET.toString());
	}
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingEObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		isHighlightBrackets = preferenceStore.getBoolean(eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));

 ...
 * </p>
 */
public class HymappingNewProjectWizard extends Wizard implements INewWizard, IExecutableExtension {
	
	/**
	 * The name of the ZIP file that is used as content for the new project (relative
	 * to the root of the resource UI plug-in).
	 */
	public final static String NEW_PROJECT_ZIP_FILE_NAME = eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingUIResourceBundle.NEW_PROJECT_ZIP_FILE_NAME;
	 ...
	 */
	protected String pageName = eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_NAME;
	 ...
	 */
	protected String pageDescription = eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_DESCRIPTION;
	
	/**
	 * The name of the project in the project creation page
	 */
	protected String pageProjectName = eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingUIResourceBundle.NEW_PROJECT_WIZARD_PROJECT_NAME;
	 ...
	 * eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingNewProjectWizardLogic.
	 */
	...
	protected void doPerformFinish(IProgressMonitor monitor) throws Exception {
		new eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingNewProjectWizardLogic().createExampleProject(monitor, wizardNewProjectCreationPage.getLocationPath(), wizardNewProjectCreationPage.getProjectName(), eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingUIPlugin.PLUGIN_ID, NEW_PROJECT_ZIP_FILE_NAME);
	}

 ...
 * a specified depth.
 */
public class HymappingOutlinePageTreeViewer extends TreeViewer {
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			eu.hyvar.feature.mapping.resource.hymapping.mopp.HymappingPlugin.logError("Exception while refreshing outline view", e);
		}
	}

...
public class HymappingPropertySheetPage extends PropertySheetPage implements ISelectionChangedListener {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection iSelection) {
		...
		if (iSelection instanceof eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingEObjectSelection) {
			final eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingEObjectSelection selection = (eu.hyvar.feature.mapping.resource.hymapping.ui.HymappingEObjectSelection) iSelection;

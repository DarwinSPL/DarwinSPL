...
public class HyGroupTypeDialog extends TypeDialog {
	public HyGroupTypeDialog(Shell parentShell) {
		super(parentShell);
	...
	protected void addItem(EObject object){
		...
		HyGroup group = ((HyGroupWrapped)this.getElement()).getWrappedModelElement();
		String cardinality = "";

package eu.hyvar.feature.graphical.editor.locators;
...
public class HyAttributeCellEditorLocator implements CellEditorLocator{
	private Label label;
	
	public HyAttributeCellEditorLocator(Label label){
		this.label = label;
	}

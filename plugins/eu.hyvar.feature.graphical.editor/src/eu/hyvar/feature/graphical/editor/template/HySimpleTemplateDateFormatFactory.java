...
public class HySimpleTemplateDateFormatFactory extends TemplateDateFormatFactory {
	public static final HySimpleTemplateDateFormatFactory INSTANCE
	= new HySimpleTemplateDateFormatFactory();

	private HySimpleTemplateDateFormatFactory() {

...
import dw.darwinspl.feature.graphical.editor.commands.feature.DwFeatureCreateCommand;
...
public class DwFeatureCreateSiblingAction extends DwFeatureSelectionAction{
	...
	protected Command createCommand(Object acceptedModel) {
		...
		DwFeatureCreateCommand command = new DwFeatureCreateCommand(editor.getModelWrapped().getWrappedFeature(child.getParent()), (DwGraphicalFeatureModelViewer)editor);
		return command;
	}	
}

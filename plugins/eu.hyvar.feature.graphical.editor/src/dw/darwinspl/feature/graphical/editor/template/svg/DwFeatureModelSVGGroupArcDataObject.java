 ...
 *
 */
public class DwFeatureModelSVGGroupArcDataObject {
	double startX;
	...
	public DwFeatureModelSVGGroupArcDataObject(double startX, double startY, double centerX, double centerY, double endX, double endY) {
		super();

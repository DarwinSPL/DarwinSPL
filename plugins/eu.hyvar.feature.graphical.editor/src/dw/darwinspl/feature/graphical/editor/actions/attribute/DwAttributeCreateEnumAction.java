...
import dw.darwinspl.feature.graphical.editor.dialogs.DwEnumDialog;
...
public class DwAttributeCreateEnumAction extends DwAttributeCreateAction{
	...
	public DwAttributeCreateEnumAction(DwGraphicalFeatureModelViewer editor) {
		super(editor);

 ...
 * </p>
 */
public class HyvalidityformulaSyntaxColoringPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public HyvalidityformulaSyntaxColoringPreferencePage() {
		super();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(Composite composite, int horizontalSpan) {
		eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaPixelConverter pixelConverter = new eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaEditor) {
			eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaEditor emfTextEditor = (eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaEditor) editor;

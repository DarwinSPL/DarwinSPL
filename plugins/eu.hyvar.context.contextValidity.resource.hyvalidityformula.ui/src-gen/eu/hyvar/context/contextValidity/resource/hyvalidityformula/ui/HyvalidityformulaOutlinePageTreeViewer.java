 ...
 * a specified depth.
 */
public class HyvalidityformulaOutlinePageTreeViewer extends TreeViewer {
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaPlugin.logError("Exception while refreshing outline view", e);
		}
	}

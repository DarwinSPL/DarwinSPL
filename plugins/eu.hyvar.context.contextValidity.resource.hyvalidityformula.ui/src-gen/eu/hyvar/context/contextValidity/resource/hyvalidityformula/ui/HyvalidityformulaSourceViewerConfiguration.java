 ...
 */
public class HyvalidityformulaSourceViewerConfiguration extends TextSourceViewerConfiguration {
	...
	private eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaQuickAssistAssistant quickAssistAssistant;
	private eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.IHyvalidityformulaTokenScanner tokenScanner;
	...
	public IAutoEditStrategy[] getAutoEditStrategies(ISourceViewer sourceViewer, String contentType) {
		return new IAutoEditStrategy[] {new eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaAutoEditStrategy()};
	}
	...
	public IPresentationReconciler getPresentationReconciler(ISourceViewer sourceViewer) {
		...
		eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaDamagerRepairer damagerRepairer = new eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaDamagerRepairer(getScanner(), resourceProvider);
	...
	public IHyperlinkDetector[] getHyperlinkDetectors(ISourceViewer sourceViewer) {
		...
		return new IHyperlinkDetector[] { new eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaHyperlinkDetector(resourceProvider.getResource()) };
	}

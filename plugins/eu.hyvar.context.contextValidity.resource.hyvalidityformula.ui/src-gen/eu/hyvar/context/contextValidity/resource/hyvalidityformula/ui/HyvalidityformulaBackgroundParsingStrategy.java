 ...
 */
public class HyvalidityformulaBackgroundParsingStrategy {
	 ...
	 */
	public void parse(DocumentEvent event, final eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaTextResource resource, final eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(IDocument document, final eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaTextResource resource, final eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaEditor editor, long delay) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaResource) {
							eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaResource concreteResource = (eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaResource) resource;

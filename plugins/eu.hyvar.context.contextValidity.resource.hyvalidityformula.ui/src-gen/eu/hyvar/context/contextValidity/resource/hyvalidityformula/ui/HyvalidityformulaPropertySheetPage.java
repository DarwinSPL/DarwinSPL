...
public class HyvalidityformulaPropertySheetPage extends PropertySheetPage implements ISelectionChangedListener {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection iSelection) {
		...
		if (iSelection instanceof eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaEObjectSelection) {
			final eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaEObjectSelection selection = (eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaEObjectSelection) iSelection;

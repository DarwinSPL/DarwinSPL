 ...
 */
public class HyvalidityformulaCompletionProposal implements Comparable<HyvalidityformulaCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaExpectedTerminal expectedTerminal;
	...
	public HyvalidityformulaCompletionProposal(eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public HyvalidityformulaCompletionProposal(eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public HyvalidityformulaCompletionProposal(eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof HyvalidityformulaCompletionProposal) {
			HyvalidityformulaCompletionProposal other = (HyvalidityformulaCompletionProposal) object;
	...
	public int compareTo(HyvalidityformulaCompletionProposal object) {
		if (object instanceof HyvalidityformulaCompletionProposal) {
			HyvalidityformulaCompletionProposal other = (HyvalidityformulaCompletionProposal) object;

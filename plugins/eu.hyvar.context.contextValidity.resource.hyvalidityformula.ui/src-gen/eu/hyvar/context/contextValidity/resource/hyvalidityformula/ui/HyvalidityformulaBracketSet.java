 ...
 */
public class HyvalidityformulaBracketSet {
	...
	private ArrayList<eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaBracketPair> bracketPairs;
	private String languageID;
	
	/**
	 * Creates a new bracket set to manage bracket pairs.
	 */
	public HyvalidityformulaBracketSet() {
		super();
		...
		this.bracketPairs = new ArrayList<eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaBracketPair>();
	}
	...
	public eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaBracketPair getBracketPair(String opening, String closing) {
		for (eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaBracketPair bracketPair : bracketPairs) {
	...
	public boolean addBracketPair(String opening, String closing, boolean closingEnabledInside, boolean closeAfterEnter) {
		...
		bracketPairs.add(new eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaBracketPair(opening, closing, closingEnabledInside, closeAfterEnter));
		return true;
	}
	...
	public boolean resetBrackets(IPreferenceStore preferenceStore) {
		String bracketPairs = preferenceStore.getString(languageID + eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaBracketPair remove(String opening, String closing) {
		for (eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public void deserialize(String bracketSet) {
		bracketPairs = new ArrayList<eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaBracketPair>();
	...
	public void highlightBrackets(IDocument document, int position, int caretOffset) {
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}

...
public class HyvalidityformulaOutlinePageTreeViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof EObject && o2 instanceof EObject) {
			...
			eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaNameProvider nameProvider = new eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaMetaInformation().createNameProvider();

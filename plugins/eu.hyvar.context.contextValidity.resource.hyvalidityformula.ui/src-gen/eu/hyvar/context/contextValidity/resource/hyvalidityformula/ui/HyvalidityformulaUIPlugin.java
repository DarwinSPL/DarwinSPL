 ...
 */
public class HyvalidityformulaUIPlugin extends AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui";
	public static final String EDITOR_ID = "eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.HyvalidityformulaEditor";
	...
	private static HyvalidityformulaUIPlugin plugin;
	
	public HyvalidityformulaUIPlugin() {
		super();
	}
	...
	public static HyvalidityformulaUIPlugin getDefault() {
		return plugin;
	}
	...
	protected static IStatus log(int type, String message, Throwable throwable) {
		IStatus status;
		if (throwable != null) {
			status = new Status(type, HyvalidityformulaUIPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new Status(type, HyvalidityformulaUIPlugin.PLUGIN_ID, message);
		}
		final HyvalidityformulaUIPlugin pluginInstance = HyvalidityformulaUIPlugin.getDefault();

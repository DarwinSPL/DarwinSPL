 ...
 * olInput</code>.
 */
public class HyvalidityformulaDocBrowserInformationControlInput {
	
	private final HyvalidityformulaDocBrowserInformationControlInput fPrevious;
	private HyvalidityformulaDocBrowserInformationControlInput fNext;
	 ...
	 */
	public HyvalidityformulaDocBrowserInformationControlInput(HyvalidityformulaDocBrowserInformationControlInput previous, EObject element, Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public HyvalidityformulaDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public HyvalidityformulaDocBrowserInformationControlInput getNext() {
		return fNext;
	}

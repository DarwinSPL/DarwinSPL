 ...
 */
public class HyvalidityformulaOutlinePage extends Page implements ISelectionProvider, ISelectionChangedListener, IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.outlinecontext";
	...
	public HyvalidityformulaOutlinePage(eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaResourceProvider resourceProvider) {
		super();
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("eu.hyvar.context.contextValidity.resource.hyvalidityformula.ui.outlinecontext", menuManager, treeViewer);
	}

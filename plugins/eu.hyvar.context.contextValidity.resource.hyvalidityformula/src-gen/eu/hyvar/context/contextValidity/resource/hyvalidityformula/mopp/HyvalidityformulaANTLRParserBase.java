...
public abstract class HyvalidityformulaANTLRParserBase extends Parser implements eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaTextParser {
	 ...
	 * result object.
	 */
	protected Collection<eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaCommand<eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaTextResource>> postParseCommands;
	 ...
	 */
	private eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaTokenResolveResult tokenResolveResult = new eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaTokenResolveResult();
	...
	public HyvalidityformulaANTLRParserBase(TokenStream input) {
		super(input);
	}
	
	public HyvalidityformulaANTLRParserBase(TokenStream input, RecognizerSharedState state) {
		super(input, state);
	}
	
	protected void retrieveLayoutInformation(EObject element, eu.hyvar.context.contextValidity.resource.hyvalidityformula.grammar.HyvalidityformulaSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		isElementToStore |= syntaxElement instanceof eu.hyvar.context.contextValidity.resource.hyvalidityformula.grammar.HyvalidityformulaPlaceholder;
		isElementToStore |= syntaxElement instanceof eu.hyvar.context.contextValidity.resource.hyvalidityformula.grammar.HyvalidityformulaKeyword;
		isElementToStore |= syntaxElement instanceof eu.hyvar.context.contextValidity.resource.hyvalidityformula.grammar.HyvalidityformulaEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof eu.hyvar.context.contextValidity.resource.hyvalidityformula.grammar.HyvalidityformulaBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
		...
		layoutInformationAdapter.addLayoutInformation(new eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaLayoutInformation(syntaxElement, object, offset, hiddenTokenText.toString(), visibleTokenText.toString()));
	...
	protected <ContainerType extends EObject, ReferenceType extends EObject> void registerContextDependentProxy(final eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaContextDependentURIFragmentFactory<ContainerType, ReferenceType> factory, final ContainerType container, final EReference reference, final String id, final EObject proxy) {
		final int position;
		if (reference.isMany()) {
	...
	protected void addMapEntry(EObject element, EStructuralFeature structuralFeature, eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaDummyEObject dummy) {
		Object value = element.eGet(structuralFeature);
		Object mapKey = dummy.getValueByName("key");
		Object mapValue = dummy.getValueByName("value");
		if (value instanceof EMap<?, ?>) {
			EMap<Object, Object> valueMap = eu.hyvar.context.contextValidity.resource.hyvalidityformula.util.HyvalidityformulaMapUtil.castToEMap(value);
	...
	protected EObject apply(EObject target, List<EObject> dummyEObjects) {
		...
		for (EObject object : dummyEObjects) {
			assert(object instanceof eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaDummyEObject);
			eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaDummyEObject dummy = (eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaDummyEObject) object;
	...
	protected eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaTokenResolveResult getFreshTokenResolveResult() {
	...
	protected eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaReferenceResolverSwitch getReferenceResolverSwitch() {
		eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaReferenceResolverSwitch resolverSwitch = (eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaReferenceResolverSwitch) metaInformation.getReferenceResolverSwitch();
	...
	public boolean isLayoutInformationRecordingEnabled() {
		...
		Object value = options.get(eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaOptions.DISABLE_LAYOUT_INFORMATION_RECORDING);
	...
	public boolean isLocationMapEnabled() {
		...
		Object value = options.get(eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaOptions.DISABLE_LOCATION_MAP);
		return value == null || Boolean.FALSE.equals(value);
	}

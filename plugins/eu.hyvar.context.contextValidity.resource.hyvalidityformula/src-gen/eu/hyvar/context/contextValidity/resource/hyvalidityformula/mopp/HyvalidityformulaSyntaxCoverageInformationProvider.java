...
public class HyvalidityformulaSyntaxCoverageInformationProvider {
	...
	public EClass[] getClassesWithSyntax() {
		return new EClass[] {
			...
			eu.hyvar.context.contextValidity.HyContextValidityPackage.eINSTANCE.getHyAttributeValidityFormula(),
			...
			eu.hyvar.feature.expression.HyExpressionPackage.eINSTANCE.getHyMinimumExpression(),
			eu.hyvar.feature.expression.HyExpressionPackage.eINSTANCE.getHyMaximumExpression(),
			eu.hyvar.feature.expression.HyExpressionPackage.eINSTANCE.getHyIfPossibleExpression(),
			eu.hyvar.feature.expression.HyExpressionPackage.eINSTANCE.getHyLessExpression(),
			eu.hyvar.feature.expression.HyExpressionPackage.eINSTANCE.getHyLessOrEqualExpression(),
			eu.hyvar.feature.expression.HyExpressionPackage.eINSTANCE.getHyGreaterExpression(),
			eu.hyvar.feature.expression.HyExpressionPackage.eINSTANCE.getHyGreaterOrEqualExpression(),
			...
			eu.hyvar.feature.expression.HyExpressionPackage.eINSTANCE.getHyEqualExpression(),
			eu.hyvar.feature.expression.HyExpressionPackage.eINSTANCE.getHyNotEqualExpression(),

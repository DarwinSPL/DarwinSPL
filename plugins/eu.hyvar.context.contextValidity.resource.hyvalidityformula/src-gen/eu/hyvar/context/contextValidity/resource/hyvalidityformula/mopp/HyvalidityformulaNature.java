...
public class HyvalidityformulaNature implements IProjectNature {
	
	public static final String NATURE_ID = "eu.hyvar.context.contextValidity.resource.hyvalidityformula.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}

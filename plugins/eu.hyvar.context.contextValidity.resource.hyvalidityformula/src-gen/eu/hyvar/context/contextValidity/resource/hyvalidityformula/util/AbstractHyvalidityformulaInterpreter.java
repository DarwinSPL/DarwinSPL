 ...
 */
public class AbstractHyvalidityformulaInterpreter<ResultType, ContextType> {
	
	private Stack<EObject> interpretationStack = new Stack<EObject>();
	private List<eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaInterpreterListener> listeners = new ArrayList<eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaInterpreterListener>();
	...
	public ResultType interprete(EObject object, ContextType context) {
		ResultType result = null;
		if (object instanceof eu.hyvar.context.contextValidity.HyValidityModel) {
			result = interprete_eu_hyvar_context_contextValidity_HyValidityModel((eu.hyvar.context.contextValidity.HyValidityModel) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof eu.hyvar.context.contextValidity.HyFeatureValidityFormula) {
			result = interprete_eu_hyvar_context_contextValidity_HyFeatureValidityFormula((eu.hyvar.context.contextValidity.HyFeatureValidityFormula) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof eu.hyvar.context.contextValidity.HyAttributeValidityFormula) {
			result = interprete_eu_hyvar_context_contextValidity_HyAttributeValidityFormula((eu.hyvar.context.contextValidity.HyAttributeValidityFormula) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof eu.hyvar.context.contextValidity.HyValidityFormula) {
			result = interprete_eu_hyvar_context_contextValidity_HyValidityFormula((eu.hyvar.context.contextValidity.HyValidityFormula) object, context);
		}
		if (result != null) {
			return result;
		}
	...
	public ResultType interprete_eu_hyvar_context_contextValidity_HyValidityModel(HyValidityModel hyValidityModel, ContextType context) {
		return null;
	}
	
	public ResultType interprete_eu_hyvar_context_contextValidity_HyValidityFormula(HyValidityFormula hyValidityFormula, ContextType context) {
		return null;
	}
	
	public ResultType interprete_eu_hyvar_context_contextValidity_HyFeatureValidityFormula(HyFeatureValidityFormula hyFeatureValidityFormula, ContextType context) {
		return null;
	}
	
	public ResultType interprete_eu_hyvar_context_contextValidity_HyAttributeValidityFormula(HyAttributeValidityFormula hyAttributeValidityFormula, ContextType context) {
		return null;
	}
	...
	private void notifyListeners(EObject element) {
		for (eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaInterpreterListener listener : listeners) {
	...
	public void addListener(eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaInterpreterListener newListener) {
		listeners.add(newListener);
	}
	
	public boolean removeListener(eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaInterpreterListener listener) {

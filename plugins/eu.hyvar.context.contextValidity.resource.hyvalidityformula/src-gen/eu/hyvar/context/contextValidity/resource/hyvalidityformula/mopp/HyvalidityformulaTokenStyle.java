...
public class HyvalidityformulaTokenStyle implements eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaTokenStyle {
	...
	public HyvalidityformulaTokenStyle(int[] colorAsRGB, int[] backgroundColorAsRGB, boolean bold, boolean italic, boolean striketrough, boolean underline) {
		super();
	...
	public HyvalidityformulaTokenStyle(eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaTokenStyle styleToCopy) {
	...
	public boolean equals(Object obj) {
		...
		eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaTokenStyle other = (eu.hyvar.context.contextValidity.resource.hyvalidityformula.mopp.HyvalidityformulaTokenStyle) obj;

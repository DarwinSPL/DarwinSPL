...
public class HyRelativeVersionRestrictionVersionReferenceResolver implements eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaReferenceResolver<eu.hyvar.feature.expression.HyRelativeVersionRestriction, eu.hyvar.feature.HyVersion> {
	
	private eu.hyvar.feature.expression.resource.hyexpression.analysis.HyRelativeVersionRestrictionVersionReferenceResolver delegate = new eu.hyvar.feature.expression.resource.hyexpression.analysis.HyRelativeVersionRestrictionVersionReferenceResolver();
	
	public void resolve(String identifier, eu.hyvar.feature.expression.HyRelativeVersionRestriction container, EReference reference, int position, boolean resolveFuzzy, final eu.hyvar.context.contextValidity.resource.hyvalidityformula.IHyvalidityformulaReferenceResolveResult<eu.hyvar.feature.HyVersion> result) {

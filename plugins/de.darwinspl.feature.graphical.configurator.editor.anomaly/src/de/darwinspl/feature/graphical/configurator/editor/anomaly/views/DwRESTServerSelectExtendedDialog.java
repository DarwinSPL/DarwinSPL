...
public class DwRESTServerSelectExtendedDialog extends DwRESTServerSelectDialog {
	...
	public DwRESTServerSelectExtendedDialog(Shell parentShell, String uri, Boolean isHttpAuthEnabled, String username,
			String password, Boolean isEvolutionAware, Date startDate, Date endDate,
			TypeOfEvolutionAwareAnalysis evolutionAwareAnalysisType) {

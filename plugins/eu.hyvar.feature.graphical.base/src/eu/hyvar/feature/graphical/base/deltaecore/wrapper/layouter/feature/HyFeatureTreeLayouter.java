...
public class HyFeatureTreeLayouter {
	...
	public HyFeatureTreeLayouter(HyFeatureModelEvolutionWrapped featureModel) {
		...
		TreeForTreeLayout<HyFeature> tree = new HyFeatureTreeForTreeLayout(initialVersion, featureModel.getSelectedDate());
		HyFeatureNodeExtentProvider extentProvider = new HyFeatureNodeExtentProvider(featureModel);

...
public class DwHiddenChildrenIndicatorFigure extends DwGradientFillCircleFigure {
	...
	public DwHiddenChildrenIndicatorFigure(HyFeatureWrapped feature, HyFeatureModelWrapped featureModel) {
	 ...
	 * @return
	 */
	private int getFeatureChildrenCount(HyFeatureWrapped feature, Date date){
		int count = 0;

 ...
 */
public class HydatavalueTextHover implements ITextHover, ITextHoverExtension, ITextHoverExtension2 {
	...
	private eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends Action {
		...
		private final eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueDocBrowserInformationControlInput infoInput = (eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueHyperlink hyperlink = new eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	 ...
	 */
	public HydatavalueTextHover(eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
		...
		return ((eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueDocBrowserInformationControlInput internalGetHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
	 ...
	 */
	private eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueDocBrowserInformationControlInput getHoverInfo(List<EObject> elements, ITextViewer textViewer, eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueHTMLPrinter.insertPageProlog(buffer, 0, eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueTextHover.getStyleSheet());
			eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueHTMLPrinter.addPageEpilog(buffer);
			return new eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		Bundle bundle = Platform.getBundle(eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueUIPlugin.PLUGIN_ID);
		URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return eu.hyvar.dataValues.resource.hydatavalue.util.HydatavalueStreamUtil.getContent(styleSheetURL.openStream());

 ...
 */
public class HydatavalueHighlighting implements ISelectionProvider, ISelectionChangedListener {
	...
	private eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueEditor editor;
	private ProjectionViewer projectionViewer;
	private eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueOccurrence occurrence;
	private eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueBackgroundParsingListener {
	...
	private void addListeners(eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueEditor editor) {
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavaluePositionCategory.BRACKET.toString());
	}
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueEObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		isHighlightBrackets = preferenceStore.getBoolean(eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavaluePreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavaluePreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));

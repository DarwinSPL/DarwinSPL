...
public class HydatavalueOutlinePageTreeViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof EObject && o2 instanceof EObject) {
			...
			eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueNameProvider nameProvider = new eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueMetaInformation().createNameProvider();

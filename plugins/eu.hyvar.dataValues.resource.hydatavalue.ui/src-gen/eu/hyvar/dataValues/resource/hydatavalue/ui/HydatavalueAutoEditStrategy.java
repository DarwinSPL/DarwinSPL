...
/**
 * The HydatavalueAutoEditStrategy extends the default auto edit strategy such
 ...
 */
public class HydatavalueAutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	
	private eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueBracketSet bracketSet;
	
	public HydatavalueAutoEditStrategy() {
		super();
		...
		if (plugin != null) {
			...
			bracketSet = new eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueBracketSet();
	 ...
	 */
	@Deprecated
	public void setBracketSet(eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueBracketSet bracketSet) {

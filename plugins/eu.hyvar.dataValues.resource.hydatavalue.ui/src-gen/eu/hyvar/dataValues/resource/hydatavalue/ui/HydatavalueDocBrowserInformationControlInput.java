 ...
 * olInput</code>.
 */
public class HydatavalueDocBrowserInformationControlInput {
	
	private final HydatavalueDocBrowserInformationControlInput fPrevious;
	private HydatavalueDocBrowserInformationControlInput fNext;
	 ...
	 */
	public HydatavalueDocBrowserInformationControlInput(HydatavalueDocBrowserInformationControlInput previous, EObject element, Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public HydatavalueDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public HydatavalueDocBrowserInformationControlInput getNext() {
		return fNext;
	}

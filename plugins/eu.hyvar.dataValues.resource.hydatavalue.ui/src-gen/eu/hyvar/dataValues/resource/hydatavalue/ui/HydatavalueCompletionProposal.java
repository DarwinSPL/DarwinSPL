 ...
 */
public class HydatavalueCompletionProposal implements Comparable<HydatavalueCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueExpectedTerminal expectedTerminal;
	...
	public HydatavalueCompletionProposal(eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public HydatavalueCompletionProposal(eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public HydatavalueCompletionProposal(eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof HydatavalueCompletionProposal) {
			HydatavalueCompletionProposal other = (HydatavalueCompletionProposal) object;
	...
	public int compareTo(HydatavalueCompletionProposal object) {
		if (object instanceof HydatavalueCompletionProposal) {
			HydatavalueCompletionProposal other = (HydatavalueCompletionProposal) object;

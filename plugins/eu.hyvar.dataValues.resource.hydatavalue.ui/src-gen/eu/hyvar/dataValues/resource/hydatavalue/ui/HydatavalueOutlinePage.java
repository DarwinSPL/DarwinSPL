 ...
 */
public class HydatavalueOutlinePage extends Page implements ISelectionProvider, ISelectionChangedListener, IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "eu.hyvar.dataValues.resource.hydatavalue.ui.outlinecontext";
	...
	public HydatavalueOutlinePage(eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueResourceProvider resourceProvider) {
		super();
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("eu.hyvar.dataValues.resource.hydatavalue.ui.outlinecontext", menuManager, treeViewer);
	}

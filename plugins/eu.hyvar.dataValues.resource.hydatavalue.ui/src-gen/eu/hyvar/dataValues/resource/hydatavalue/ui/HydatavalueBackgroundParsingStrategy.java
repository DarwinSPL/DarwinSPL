 ...
 */
public class HydatavalueBackgroundParsingStrategy {
	 ...
	 */
	public void parse(DocumentEvent event, final eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueTextResource resource, final eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(IDocument document, final eu.hyvar.dataValues.resource.hydatavalue.IHydatavalueTextResource resource, final eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueEditor editor, long delay) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueResource) {
							eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueResource concreteResource = (eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueResource) resource;

 ...
 */
public class HydatavalueUIPlugin extends AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "eu.hyvar.dataValues.resource.hydatavalue.ui";
	public static final String EDITOR_ID = "eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueEditor";
	...
	private static HydatavalueUIPlugin plugin;
	
	public HydatavalueUIPlugin() {
		super();
	}
	...
	public static HydatavalueUIPlugin getDefault() {
		return plugin;
	}
	...
	protected static IStatus log(int type, String message, Throwable throwable) {
		IStatus status;
		if (throwable != null) {
			status = new Status(type, HydatavalueUIPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new Status(type, HydatavalueUIPlugin.PLUGIN_ID, message);
		}
		final HydatavalueUIPlugin pluginInstance = HydatavalueUIPlugin.getDefault();

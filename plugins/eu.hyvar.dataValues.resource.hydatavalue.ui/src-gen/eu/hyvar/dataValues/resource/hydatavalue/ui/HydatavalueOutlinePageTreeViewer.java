 ...
 * a specified depth.
 */
public class HydatavalueOutlinePageTreeViewer extends TreeViewer {
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavaluePlugin.logError("Exception while refreshing outline view", e);
		}
	}

...
public class HydatavaluePropertySheetPage extends PropertySheetPage implements ISelectionChangedListener {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection iSelection) {
		...
		if (iSelection instanceof eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueEObjectSelection) {
			final eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueEObjectSelection selection = (eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueEObjectSelection) iSelection;

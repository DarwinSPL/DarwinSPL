 ...
 * </p>
 */
public class HydatavalueSyntaxColoringPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public HydatavalueSyntaxColoringPreferencePage() {
		super();
		
		eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueMetaInformation metaInformation = new eu.hyvar.dataValues.resource.hydatavalue.mopp.HydatavalueMetaInformation();
		...
		setPreferenceStore(eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueUIPlugin.getDefault().getPreferenceStore());
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(Composite composite, int horizontalSpan) {
		eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavaluePixelConverter pixelConverter = new eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavaluePixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueEditor) {
			eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueEditor emfTextEditor = (eu.hyvar.dataValues.resource.hydatavalue.ui.HydatavalueEditor) editor;

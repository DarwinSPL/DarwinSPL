...
/**
 * This is the item provider adapter for a {@link eu.hyvar.feature.HyRootFeature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HyRootFeatureItemProvider 
	 ...
	 * @generated
	 */
	public HyRootFeatureItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addFeaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HyRootFeature_feature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HyRootFeature_feature_feature", "_UI_HyRootFeature_type"),
				 HyFeaturePackage.Literals.HY_ROOT_FEATURE__FEATURE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns HyRootFeature.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HyRootFeature"));
	}
	...
	public String getText(Object object) {
		String label = ((HyRootFeature)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_HyRootFeature_type") :
			getString("_UI_HyRootFeature_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HyRootFeature.class)) {
			case HyFeaturePackage.HY_ROOT_FEATURE__VALID_SINCE:
			case HyFeaturePackage.HY_ROOT_FEATURE__VALID_UNTIL:
			case HyFeaturePackage.HY_ROOT_FEATURE__ID:

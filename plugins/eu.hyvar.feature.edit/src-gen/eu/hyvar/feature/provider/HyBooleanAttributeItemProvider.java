...
/**
 * This is the item provider adapter for a {@link eu.hyvar.feature.HyBooleanAttribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HyBooleanAttributeItemProvider 
	 ...
	 * @generated
	 */
	public HyBooleanAttributeItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addDefaultPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HyBooleanAttribute_default_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HyBooleanAttribute_default_feature", "_UI_HyBooleanAttribute_type"),
				 HyFeaturePackage.Literals.HY_BOOLEAN_ATTRIBUTE__DEFAULT,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns HyBooleanAttribute.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HyBooleanAttribute"));
	}
	...
	public String getText(Object object) {
		String label = ((HyBooleanAttribute)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_HyBooleanAttribute_type") :
			getString("_UI_HyBooleanAttribute_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HyBooleanAttribute.class)) {
			case HyFeaturePackage.HY_BOOLEAN_ATTRIBUTE__VALID_SINCE:
			case HyFeaturePackage.HY_BOOLEAN_ATTRIBUTE__VALID_UNTIL:
			case HyFeaturePackage.HY_BOOLEAN_ATTRIBUTE__ID:
			case HyFeaturePackage.HY_BOOLEAN_ATTRIBUTE__DEFAULT:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case HyFeaturePackage.HY_BOOLEAN_ATTRIBUTE__NAMES:

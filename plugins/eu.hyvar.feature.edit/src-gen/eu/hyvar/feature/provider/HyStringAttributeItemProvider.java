...
/**
 * This is the item provider adapter for a {@link eu.hyvar.feature.HyStringAttribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HyStringAttributeItemProvider 
	 ...
	 * @generated
	 */
	public HyStringAttributeItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addDefaultPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HyStringAttribute_default_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HyStringAttribute_default_feature", "_UI_HyStringAttribute_type"),
				 HyFeaturePackage.Literals.HY_STRING_ATTRIBUTE__DEFAULT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns HyStringAttribute.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HyStringAttribute"));
	}
	...
	public String getText(Object object) {
		String label = ((HyStringAttribute)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_HyStringAttribute_type") :
			getString("_UI_HyStringAttribute_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HyStringAttribute.class)) {
			case HyFeaturePackage.HY_STRING_ATTRIBUTE__VALID_SINCE:
			case HyFeaturePackage.HY_STRING_ATTRIBUTE__VALID_UNTIL:
			case HyFeaturePackage.HY_STRING_ATTRIBUTE__ID:
			case HyFeaturePackage.HY_STRING_ATTRIBUTE__DEFAULT:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case HyFeaturePackage.HY_STRING_ATTRIBUTE__NAMES:

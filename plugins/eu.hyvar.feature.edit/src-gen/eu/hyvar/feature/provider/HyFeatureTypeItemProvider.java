...
/**
 * This is the item provider adapter for a {@link eu.hyvar.feature.HyFeatureType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HyFeatureTypeItemProvider 
	 ...
	 * @generated
	 */
	public HyFeatureTypeItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HyFeatureType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HyFeatureType_type_feature", "_UI_HyFeatureType_type"),
				 HyFeaturePackage.Literals.HY_FEATURE_TYPE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns HyFeatureType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HyFeatureType"));
	}
	...
	public String getText(Object object) {
		String label = ((HyFeatureType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_HyFeatureType_type") :
			getString("_UI_HyFeatureType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HyFeatureType.class)) {
			case HyFeaturePackage.HY_FEATURE_TYPE__VALID_SINCE:
			case HyFeaturePackage.HY_FEATURE_TYPE__VALID_UNTIL:
			case HyFeaturePackage.HY_FEATURE_TYPE__ID:
			case HyFeaturePackage.HY_FEATURE_TYPE__TYPE:

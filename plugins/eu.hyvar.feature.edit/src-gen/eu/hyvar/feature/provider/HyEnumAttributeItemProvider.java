...
/**
 * This is the item provider adapter for a {@link eu.hyvar.feature.HyEnumAttribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HyEnumAttributeItemProvider 
	 ...
	 * @generated
	 */
	public HyEnumAttributeItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addEnumTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HyEnumAttribute_enumType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HyEnumAttribute_enumType_feature", "_UI_HyEnumAttribute_type"),
				 HyFeaturePackage.Literals.HY_ENUM_ATTRIBUTE__ENUM_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDefaultPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HyEnumAttribute_default_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HyEnumAttribute_default_feature", "_UI_HyEnumAttribute_type"),
				 HyFeaturePackage.Literals.HY_ENUM_ATTRIBUTE__DEFAULT,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns HyEnumAttribute.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HyEnumAttribute"));
	}
	...
	public String getText(Object object) {
		String label = ((HyEnumAttribute)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_HyEnumAttribute_type") :
			getString("_UI_HyEnumAttribute_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HyEnumAttribute.class)) {
			case HyFeaturePackage.HY_ENUM_ATTRIBUTE__VALID_SINCE:
			case HyFeaturePackage.HY_ENUM_ATTRIBUTE__VALID_UNTIL:
			case HyFeaturePackage.HY_ENUM_ATTRIBUTE__ID:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case HyFeaturePackage.HY_ENUM_ATTRIBUTE__NAMES:

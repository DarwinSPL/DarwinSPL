...
public class HymanifestMapUtil {
	...
	public static <K> void putAndMergeKeys(Map<K, Object> map, K key, Object value) {
		...
		if (map.containsKey(key)) {
			...
			if (currentValue instanceof List<?>) {
				...
				List<Object> currentValueAsObjectList = eu.hyvar.mspl.manifest.resource.hymanifest.util.HymanifestListUtil.copySafelyToObjectList(currentValueAsList);

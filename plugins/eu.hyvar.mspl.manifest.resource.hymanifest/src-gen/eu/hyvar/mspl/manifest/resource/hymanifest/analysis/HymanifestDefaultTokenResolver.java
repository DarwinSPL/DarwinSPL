 ...
 * </p>
 */
public class HymanifestDefaultTokenResolver implements eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestTokenResolver {
	 ...
	 */
	public HymanifestDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public HymanifestDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, EStructuralFeature feature, eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : eu.hyvar.mspl.manifest.resource.hymanifest.grammar.HymanifestGrammarInformationProvider.INSTANCE.getKeywords()) {

 ...
 */
public class HymanifestRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {

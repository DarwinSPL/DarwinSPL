...
/**
 * A HymanifestContainmentTrace represents a specific path to a structural feature
 * by navigating over a set of a structural feature from a start class.
 * HymanifestContainmentTraces are used during code completion to reconstruct
 ...
 */
public class HymanifestContainmentTrace {
	 ...
	 */
	private eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestContainedFeature[] path;
	
	public HymanifestContainmentTrace(EClass startClass, eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestContainedFeature[] path) {
		super();
		// Verify arguments
		if (startClass != null) {
			if (path.length > 0) {
	...
	public eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestContainedFeature[] getPath() {
		return path;
	}

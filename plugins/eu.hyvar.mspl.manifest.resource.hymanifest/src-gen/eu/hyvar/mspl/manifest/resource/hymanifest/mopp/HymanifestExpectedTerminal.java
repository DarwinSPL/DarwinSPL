 ...
 */
public class HymanifestExpectedTerminal {
	...
	private eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private eu.hyvar.mspl.manifest.resource.hymanifest.grammar.HymanifestContainmentTrace containmentTrace;
	
	public HymanifestExpectedTerminal(EObject container, eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestExpectedElement terminal, int followSetID, eu.hyvar.mspl.manifest.resource.hymanifest.grammar.HymanifestContainmentTrace containmentTrace) {
		super();
	...
	public eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		HymanifestExpectedTerminal otherExpectedTerminal = (HymanifestExpectedTerminal) o;
	...
	public eu.hyvar.mspl.manifest.resource.hymanifest.grammar.HymanifestContainmentTrace getContainmentTrace() {

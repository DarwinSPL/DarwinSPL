...
public class HymanifestNature implements IProjectNature {
	
	public static final String NATURE_ID = "eu.hyvar.mspl.manifest.resource.hymanifest.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}

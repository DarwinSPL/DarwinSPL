 ...
 * conversion.
 */
public interface IHymanifestInputStreamProcessorProvider {
	 ...
	 */
	public eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestInputStreamProcessor getInputStreamProcessor(InputStream inputStream);
}

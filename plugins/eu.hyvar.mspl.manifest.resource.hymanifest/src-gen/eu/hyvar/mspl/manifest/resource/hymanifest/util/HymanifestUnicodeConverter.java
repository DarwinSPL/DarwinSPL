 ...
 * to 4 bytes).
 */
public class HymanifestUnicodeConverter extends eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestInputStreamProcessor {
	 ...
	 */
	public HymanifestUnicodeConverter(InputStream inputStream) {

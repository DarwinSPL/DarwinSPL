 ...
 */
public class HymanifestEObjectUtil {
	...
	public static Object invokeOperation(EObject element, EOperation o) {
		...
		try {
			...
			new eu.hyvar.mspl.manifest.resource.hymanifest.util.HymanifestRuntimeUtil().logError("Exception while matching proxy URI.", e);

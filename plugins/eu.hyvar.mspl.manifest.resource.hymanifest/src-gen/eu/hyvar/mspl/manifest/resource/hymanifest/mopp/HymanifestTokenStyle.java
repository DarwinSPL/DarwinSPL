...
public class HymanifestTokenStyle implements eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestTokenStyle {
	...
	public HymanifestTokenStyle(int[] colorAsRGB, int[] backgroundColorAsRGB, boolean bold, boolean italic, boolean striketrough, boolean underline) {
		super();
	...
	public HymanifestTokenStyle(eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestTokenStyle styleToCopy) {
	...
	public boolean equals(Object obj) {
		...
		eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestTokenStyle other = (eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestTokenStyle) obj;

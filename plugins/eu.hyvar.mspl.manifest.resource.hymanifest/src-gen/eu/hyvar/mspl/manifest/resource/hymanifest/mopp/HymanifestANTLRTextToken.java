...
public class HymanifestANTLRTextToken extends eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestTextToken {
	
	private final static eu.hyvar.mspl.manifest.resource.hymanifest.IHymanifestMetaInformation metaInformation = new eu.hyvar.mspl.manifest.resource.hymanifest.mopp.HymanifestMetaInformation();
	
	public HymanifestANTLRTextToken(Token antlrToken) {

...
/**
 * <p>
 * HymanifestLayoutInformation objects are used to store layout information that
 ...
 * </p>
 * <p>
 * HymanifestLayoutInformations are aggregated in LayoutInformationAdapters. One
 * HymanifestLayoutInformation contains the layout that was found before a
 * keyword, attribute or reference.
 * </p>
 */
public class HymanifestLayoutInformation {
	 ...
	 */
	private final eu.hyvar.mspl.manifest.resource.hymanifest.grammar.HymanifestSyntaxElement syntaxElement;
	...
	public HymanifestLayoutInformation(eu.hyvar.mspl.manifest.resource.hymanifest.grammar.HymanifestSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
